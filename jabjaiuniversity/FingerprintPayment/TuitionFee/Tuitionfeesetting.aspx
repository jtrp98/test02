<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true" CodeBehind="Tuitionfeesetting.aspx.cs" Inherits="FingerprintPayment.TuitionFee.Tuitionfeesetting" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="script/Tuitionfeesetting-2.js?d=<%=DateTime.Now.ToString("ddMMyyyyHHmmsss") %>" type="text/javascript"></script>
</asp:Content>
            ...
            <div class="col-xs-12 col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <span><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M00694") %></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table id="tableAddRow" class="table table-bordered table-hover tableSection" style="margin-bottom: 0px; border-top: 0px; border-right: 0px; font-size: 18px;">
                    <thead>
                        <tr style="border-top: 1px solid #ddd; background-color: #337AB7; color: white;">
                            ...
                            <th style="width: 10%" class="center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101212") %></th>
                            <th style="width: 10%" class="center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M210458") %></th>
                            <th style="width: 10%" class="center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M107039") %></th>
                            <th style="width: 10%" class="center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M502004") %></th>
                            <th style="width: 10%" class="center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M01985") %></th>
                            <th style="width: 10%" class="center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M01964") %></th>
                            <th style="width: 10%; display: none;" class="center setting"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M133392") %></th>
                            <th style="width: 10%; display: none;" class="center setting"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M02250") %></th>
