    ...
    $("#submitpeak").click(function () {
        ...
        if (savedata === false) {
            ...
            $.confirm({
                ...
                content: "<h3>รายการแจ้งหนี้ทั้งหมดจะถูกส่งไปยังแอฟพลิเคชั่น<br/>ของผู้ปกครอง ท่านต้องการทำรายการต่อไปหรือไม่</h3>",
                theme: 'bootstrap',
                buttons: {
...
function SaveInvoice(InvoicesGroup_Data) {
    PageMethods.SaveInvoice(parseInt($("#year_id").val()), $("#term_id").val(), [InvoicesGroup_Data],
        function (e) {
            rowIndex += 1;
