    ...
    public partial class uploadiframe : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (JabJaiEntities _db = new JabJaiEntities(Connection.StringConnectionSchool(HttpContext.Current.Session["sEntities"].ToString(), ConnectionDB.Read)))
            {
                ...
                var card = _db.TStudentCardInfoes.Where(w => w.SchoolID == userData.CompanyID).Where(w => w.elementName == "CardCover").FirstOrDefault();
                if (card != null)
                {
                    ...
                    blah.Src = card.elementValue + "?d=" + DateTime.Now.Ticks;
                }
            }
        ...
        protected void upload_Click(object sender, EventArgs e)
        {
            ...
            using (JabJaiEntities _db = new JabJaiEntities(Connection.StringConnectionSchool(HttpContext.Current.Session["sEntities"].ToString(), ConnectionDB.Read)))
            {
                ...
                if (FileUpload.HasFile)
                {
                    ...
                    var check = _db.TStudentCardInfoes.Where(w => w.SchoolID == userData.CompanyID).Where(w => w.elementName == "CardCover" && w.cDel == null).FirstOrDefault();
                    if (check == null)
                    {
                        card = new TStudentCardInfo();
                        card.cDel = null;
                        card.elementName = "CardCover";
                ...
                Response.Redirect("uploadiframe.aspx");
            }
        }
        ...
        public static string preRegisterPic(FileUpload files, int newwidthimg, int userid)
        {
            ...
            try
            {
                ...
                var request = new PutObjectRequest()
                {
                    ...
                    ObjectKey = "coverpic/student/" + userid + "/" + newname,
                    FilePath = path,
                };
