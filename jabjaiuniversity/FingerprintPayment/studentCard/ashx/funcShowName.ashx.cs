...
{
    /// <summary>
    /// Summary description for funcShowName
    /// </summary>
    public class funcShowName : IHttpHandler , IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var Value = fcommon.ReplaceInjection(context.Request["ShowName"]);
