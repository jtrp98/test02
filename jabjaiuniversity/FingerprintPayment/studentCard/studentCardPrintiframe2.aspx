<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="studentCardPrintiframe2.aspx.cs" Inherits="FingerprintPayment.studentCard.studentCardPrintiframe2" %>
...
<body>
    ...
    <form id="form1" autocomplete="off" runat="server">
        ...
        <script>
            $(function () {
                $(".resizeable").quickfit({ max: 16, min: 10, truncate: false, width: 200 });
            });
        </script>
    </form>
