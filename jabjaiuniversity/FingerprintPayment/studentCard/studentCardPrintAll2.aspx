<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="studentCardPrintAll2.aspx.cs" Inherits="FingerprintPayment.studentCard.studentCardPrintAll2" %>
        ...
        function start() {
            ...
            $.get("/studentCard/studentCardPaintAll.ashx?" + idlv + "&" + idlv2 + "&term=" + term, function (Result) {
                ...
                $.each(Result, function (index) {
                    ...
                    a.src = str + "iframe2.aspx?" + idlv + "&" + idlv2 + "&id=" + Result[index].sID + "&modeall=1" + "&" + wE + "&tC=" + tC + "&" + tBQ + "&" + tCL + "&" + tEXP + "&" + tNik + "&term=" + term;
                    ...
                    a.onload = function () {
                        ...
                        $(a).contents().find('#printbutton').hide();
                    };
