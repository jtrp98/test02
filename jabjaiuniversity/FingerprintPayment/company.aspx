<%@ Page Title="" Language="C#" MasterPageFile="~/mp2.Master" AutoEventWireup="true" CodeBehind="company.aspx.cs" Inherits="FingerprintPayment.company" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="detail-card box-content">
        ...
        <div class="row center">
            <div class="col-lg-2"></div>
            <div class="col-lg-8">
                <asp:Button ID="btnSave" CssClass="btn-success btn" runat="server" Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101125") %>" />
                <asp:Button ID="btnCancel" CssClass="btn-danger btn" runat="server" Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101127") %>" />
            </div>
            <div class="col-lg-2"></div>
        </div>
