<%@ Page Title="" Language="C#" MasterPageFile="~/mppopup.Master" AutoEventWireup="true" CodeBehind="leaveSetting-edit.aspx.cs" Inherits="FingerprintPayment.Leaveform.leaveSetting_edit" %>
  ...
  margin-right: -30px;
    ...
    <div class="full-card text-center planeadd-container">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <h1 class="leftText"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132336") %></h1>
                    <hr />
                <div class="form-group row" id="row-name">
                    <div class="col-xs-12">
                        <div class="col-xs-3">
                            <label><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102239") %> 1</label>
                        </div>
                        <div class="col-xs-7" >
                ...
                <div class="form-group row" id="row-name">
                    <div class="col-xs-12">
                        <div class="col-xs-3">
                            <label><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102239") %> 2</label>
                        </div>
                        <div class="col-xs-7" >
