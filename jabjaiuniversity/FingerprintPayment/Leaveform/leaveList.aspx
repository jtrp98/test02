<%@ Page Title="" Language="C#" MasterPageFile="~/Material2.Master" AutoEventWireup="true"
    CodeBehind="leaveList.aspx.cs" Inherits="FingerprintPayment.leaveList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
    ...
    <script src="LeaveDatalist.js?v=<%=DateTime.Now.Ticks%>" type="text/javascript"></script>
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="text-muted" style="font-size: small;">
                <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M301032") %>          
            </p>
        </div>
    </div>
                        ...
                        <div class=" row ">
                            ...
                            <div class="col-md-3  d-none">
                                ...
                                <%--    <asp:ListItem Enabled="true" Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M701054") %>" Value="all"></asp:ListItem>
                                    ...
                                    <asp:ListItem Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101002") %>" Selected="True" Value="student"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="col-md-1"></div>
