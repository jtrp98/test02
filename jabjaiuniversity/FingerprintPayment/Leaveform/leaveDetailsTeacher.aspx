<%@ Page Title="" Language="C#" MasterPageFile="~/Material2.Master" AutoEventWireup="true"
    CodeBehind="leaveDetailsTeacher.aspx.cs" Inherits="FingerprintPayment.leaveDetailsTeacher" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="text-muted" style="font-size: small;">
                <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102244") %>
            </p>
        </div>
    </div>
