                ...
                { "data": "letterStatus", "orderable": true },
                {
                    ...
                    "render": function (type, row, data) {
                        ...
                        if (data.letterStatus !== "ยกเลิกการลา") {
                            _html += '<a href="/Leaveform/leaveDetailsTeacher.aspx?id=' + data.letterId + '" class=" fas fa-envelope-open-text"></a>';
                            _html += ' <a href="/Leaveform/leavePrintTeacher.aspx?id=' + data.letterId + '" target="_blank" class="fa fa-print"></a>';
                            _html += ' <a href="/Leaveform/leaveRemoveTeacher.aspx?id=' + data.letterId + '" class="fa fa-remove" style="color: red;"></a>';
                        }
                        else {
                            _html += ' <a href="/Leaveform/leavePrintTeacher.aspx?id=' + data.letterId + '" target="_blank" class="fa fa-print"></a>';
                        }
