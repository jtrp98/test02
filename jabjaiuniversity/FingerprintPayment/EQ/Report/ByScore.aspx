<%@ Page Title="" Language="C#" MasterPageFile="~/Material2.Master" AutoEventWireup="true" CodeBehind="ByScore.aspx.cs" Inherits="FingerprintPayment.EQ.Report.ByScore" %>
        ...
        function SearchData(t) {
            ...
            if (t == 'data') {
                ...
                var dt = $('#template1').DataTable({
                    ...
                    "lengthChange": false,
                    ajax: {
                        url: "/EQ/Report/ByScore.aspx/LoadData",
                        type: "POST",
                    ...
                    "columns": [
                        ...
                        { "title": "<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101321") %>", data: 'Count', "class": "text-center", "width": "20%" },
                        { "title": "<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M306016") %>", data: 'High', "class": "text-center", "width": "20%" },
                        { "title": "<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103008") %>", data: 'Normal', "class": "text-center", "width": "20%" },
                        { "title": "<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M306017") %>", data: 'Low', "class": "text-center", "width": "20%" },
                ...
                var dt = new Date();
                var file_name = '<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M304030") %>_' + dt.format("ddMMyyyyHHmmssss") + '.xls';

                xhr = new XMLHttpRequest();

                xhr.open("POST", "/EQ/Report/ByScore.aspx/ExportExcel", true);
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="text-muted" style="font-size: small;">
                <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M306014") %>
            </p>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    ...
                    <div class="card-body "  >
                                ...
                                <table id="template1" class=" table-hover dataTable" width="100%" style="margin: 0 5px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 60%; text-align: center" colspan="3"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M306015") %></th>
                                        </tr>
                                        <tr>
                                            <th style="width: 20%; text-align: center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M306016") %></th>
                                            <th style="width: 20%; text-align: center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103008") %></th>
                                            <th style="width: 20%; text-align: center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M306017") %></th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                        ...
                        <div class="row result-wrapper" style="display:none">
                            <div class="col-md-12" >
                                <strong><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M306018") %>  <span id="s1"></span> / <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M306019") %>  <span id="s2"></span> / <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M306020") %>  <span id="s3"></span>
                                </strong>
                            </div>
                        </div>
                    </div>
