...
function VerifyTotalUpdatedCorrectly() {
    ...
    table.rows().every(function (rowIdx, tableLoop, rowLoop) {
        ...
        //console.log(data);
        //console.log("-------------");
        if (controlIdIndex > 0 && data.nStudentStatus == "2") {
            controlIdIndex = controlIdIndex - 1;
        }
        //console.log(data[0]);
        ...
        if (parseFloat(scoreBeforeMidTerm).toFixed(2) != parseFloat(scoreBeforeMidTermCorrectValue).toFixed(2)) {
            ...
            $('#TabBeforeMidTerm a').trigger('click');
            var assessmentControlId = $("input[name=" + response.column[5].data + "]")[controlIdIndex - 1];
            if (assessmentControlId != 'undefined')
                $(assessmentControlId).trigger("change");

            assessmentControlId = $("input[name=" + response.column[5].data + "]")[controlIdIndex];
            if (assessmentControlId != 'undefined')
                $(assessmentControlId).trigger("change");
        }
        ...
        if (parseFloat(scoreAfterMidTerm).toFixed(2) != parseFloat(scoreAfterMidTermCorrectValue).toFixed(2)) {
            ...
            $('#TabAfterMidTerm a').trigger('click');
            var assessmentControlId = $("input[name=" + response.column[35].data + "]")[controlIdIndex - 1];
            if (assessmentControlId != 'undefined')
                $(assessmentControlId).trigger("change");

            var assessmentControlId = $("input[name=" + response.column[35].data + "]")[controlIdIndex];
            if (assessmentControlId != 'undefined')
                $(assessmentControlId).trigger("change");
        }
        if (isNaN(scoreMidTermCorrectValue))
            scoreMidTermCorrectValue = 0;
        if (parseFloat(scoreMidTerm).toFixed(2) != parseFloat(scoreMidTermCorrectValue).toFixed(2)) {
            ...
            console.log(response.column[25].data);
            console.log("rowIndex" + controlIdIndex);

            var assessment = $.grep(response.Assessments, function (n) {
                return n.AssessmentId == response.column[25].data;
            });
            console.log(assessment[0].AssessmentMaxScore);
            $('#TabMidTerm a').trigger('click');

            var assessmentControlId = $("input[name=" + response.column[25].data + "]")[controlIdIndex - 1];

            if (assessmentControlId != 'undefined' && $(assessmentControlId).val() != "" && assessment[0].AssessmentMaxScore != "" && parseFloat(assessment[0].AssessmentMaxScore) >= parseFloat($(assessmentControlId).val())) {
                $(assessmentControlId).trigger("change");
                console.log(assessment[0].AssessmentMaxScore);
                console.log($(assessmentControlId).val());
                console.log("Correct Max Score");
            }

            var assessmentControlId = $("input[name=" + response.column[25].data + "]")[controlIdIndex];
        ...
        if (parseFloat(scoreFinalTerm).toFixed(2) != parseFloat(scoreFinalTermCorrectValue).toFixed(2)) {
            ...
            var assessment = $.grep(response.Assessments, function (n) {
                return n.AssessmentId == response.column[55].data;
            });

            var assessmentControlId = $("input[name=" + response.column[55].data + "]")[controlIdIndex - 1];
            if (assessmentControlId != 'undefined' && $(assessmentControlId).val() != "" && assessment[0].AssessmentMaxScore != "" && parseFloat(assessment[0].AssessmentMaxScore) >= parseFloat($(assessmentControlId).val())) {
                $(assessmentControlId).trigger("change");
                console.log("Correct Max Score");
            }
            ...
            var assessmentControlId = $("input[name=" + response.column[55].data + "]")[controlIdIndex];
            if (assessmentControlId != 'undefined' && $(assessmentControlId).val() != "" && assessment[0].AssessmentMaxScore != "" && parseFloat(assessment[0].AssessmentMaxScore) >= parseFloat($(assessmentControlId).val())) {
                $(assessmentControlId).trigger("change");
                console.log("Correct Max Score");
            }
        ...
        if (getUrlParameter("term") == "2" && ((data.scoreAfterMidTerm != null && data.scoreAfterMidTerm != "") || (data.scoreBeforeMidTerm != null && data.scoreBeforeMidTerm != "") || (data.scoreFinalTerm != "" && data.scoreFinalTerm != null)
            || (data.scoreMidTerm != "" && data.scoreMidTerm != null)) && (data.Term2TotalFor100Percentage == null
                || data.Term2TotalFor100Percentage == "null" || data.Term2TotalFor100Percentage == "")
            && (data.Term2TotalFor50Percentage == "null" || data.Term2TotalFor50Percentage == "" || data.Term2TotalFor50Percentage == null)) {
            console.log("Total Issue");

            $('#TabBeforeMidTerm a').trigger('click');
            var assessmentControlId = $("input[name=" + response.column[5].data + "]")[controlIdIndex - 1];
            if (assessmentControlId != 'undefined')
                $(assessmentControlId).trigger("change");
            console.log(assessmentControlId);
        }

        if (rowIndex == 0) { //Verify 100% score value
            ...
            if ((data.BeforeAfterMidTermTotalScore != 'undefined' && data.BeforeAfterMidTermTotalScore != null && data.BeforeAfterMidTermTotalScore != "" && data.BeforeAfterMidTermTotalScore != "0") ||
                ...
                //console.log(calculatedFields.totalGrade);
                //console.log(calculatedFields.totalScoreFor100Percent);
                //console.log(calculatedFields.quizScoreFor100Percent);
                //console.log(calculatedFields.midTermScoreFor100Percent);
                //console.log(calculatedFields.finalTermScorefor100Percent);
                //console.log(calculatedFields.getBeforeQuiz100);
                //console.log(calculatedFields.getAfterQuiz100);

                if (data.GetQuiz100 != calculatedFields.quizScoreFor100Percent) {
                    console.log(data.GetQuiz100);
                    console.log(calculatedFields.quizScoreFor100Percent);
                    console.log("Before Mid Term 100 % Total Issue");
                    $("#ddlBeforeMidTermPercentage").trigger("change");
                }

                if (data.GetMid100 != calculatedFields.midTermScoreFor100Percent) {
                    console.log("Mid Term 100 % Total Issue");
                    $("#ddlMidTermPercentage").trigger("change");
                }

                if (data.GetFinal100 != calculatedFields.finalTermScorefor100Percent) {
                    console.log("Final Term 100 % Total Issue");
                    $("#ddlFinalTermPercentage").trigger("change");
                }
            }
        }
...
function ColumnDef() {
    ...
    var getSpecialDDLValues = [
        { Value: "-1", Text: "ไม่มี", TextEng: "None" },
        { Value: "1", Text: "ร", TextEng: "I (Incomplete)" },
        { Value: "2", Text: "มส", TextEng: "N.C." },
        { Value: "3", Text: "มก", TextEng: "N.Cr." },
        { Value: "4", Text: "ผ", TextEng: "P" },
        { Value: "5", Text: "มผ", TextEng: "F" },
        { Value: "6", Text: "อื่นๆ", TextEng: "Other" },
        { Value: "7", Text: "ขร", TextEng: "I.C." },
        { Value: "8", Text: "ขส", TextEng: "I.L." },
        { Value: "9", Text: "ท", TextEng: "C" },
        { Value: "10", Text: "ดีเยี่ยม", TextEng: "Excellent" },
        { Value: "11", Text: "ดี", TextEng: "Good" },
        { Value: "12", Text: "พอใช้", TextEng: "Moderate" },
        { Value: "13", Text: "ปรับปรุง", TextEng: "Improve" },

    ];

    console.log(getSpecialDDLValues);
    var opts = "";
    $.each(getSpecialDDLValues, function (index, Value) {
        if (languageCode != "EN") {
            ...
            opts = opts + "<option value='" + Value.Value + "'>" + Value.TextEng + "</options>";
        }
    });
    console.log(opts);
    ...
    var columnDef = [
        ...
        },
        {
            render: function (data, type, row, meta) {
                ...
                decimalValue = ($("#chkGradeDicimalForFinal").is(':checked')) ? 0 : decimalValue;  //Round up final value only
...
function UpdateGradeInfo(control, controlName, OldValue) {
    ...
    else if (controlName == "chkGradeDicimal" && $("#chkGradeDicimalForFinal").is(':checked') && $("#chkGradeDicimal").is(':checked')) {
        $("#chkGradeDicimalForFinal").prop("checked", false);
    }
    else if (controlName == "chkGradeDicimalForFinal" && $("#chkGradeDicimalForFinal").is(':checked') && $("#chkGradeDicimal").is(':checked')) {
        $("#chkGradeDicimal").prop("checked", false);
    }
    ...
    var assessmentUpdateRequest = {
        ...
        GradeDicimalForFinal: $("#chkGradeDicimalForFinal").is(':checked') ? "1" : "0",
...
function UpdateAssessmentScoreInDb(newScore, sID, sPlaneID, nGradeId, assessmentId, rowNumber, selectedColIndex, assessmentTypeName) {
    ...
    midTermScoreTotalForDB = (midTermScoreTotal != 0 && (midTermScoreTotal == "" || isNaN(midTermScoreTotal))) ? "" : midTermScoreTotal;
...
function DynamicCalculation(rowNumber, beforeAfterMidTermScoreTotal, beforeMidTermScoreTotal, afterMidTermScoreTotal, midTermScoreTotal, finalTermScoreTotal) {
    ...
    decimalValue = ($("#chkGradeDicimalForFinal").is(':checked')) ? 2 : decimalValue;
    var decimalValueForFinal = ($("#chkGradeDicimalForFinal").is(':checked')) ? 0 : decimalValue;
    var beforeAfterMidTermMaxScoreTotal = $("#hdnBeforeAfterMidTermMaxScoreTotal").val();
    var beforeMidTermMaxScoreTotal = $("#hdnBeforeMidTermMaxScoreTotal").val();
    var afterMidTermMaxScoreTotal = $("#hdnAfterMidTermMaxScoreTotal").val();
    ...
    if (Number(getUrlParameter("year")) >= 2563) {
        //console.log(">2563")
        totalScoreFor100Percent = Number(Number(getBeforeQuiz100) + Number(getAfterQuiz100) + Number(midTermScoreFor100Percent) + Number(finalTermScorefor100Percent)).toFixed(decimalValueForFinal);
    }
    else {
        //console.log("<2563")
        totalScoreFor100Percent = Number(Number(quizScoreFor100Percent) + Number(midTermScoreFor100Percent) + Number(finalTermScorefor100Percent)).toFixed(decimalValueForFinal);
    }
    ...
    //if (!decimalValueForFinal) {
    //    decimalValueForFinal = 2;
    //}
    ...
    if (getUrlParameter("term") == "2" && checkAtleaseOneScoreEntered == true) {
        ...
        table.cell(rowNumber - 1, Term2TotalFor50PercentageColumnIndex).data((totalScoreFor100Percent != "") ? (parseFloat(totalScoreFor100Percent) / 2).toFixed(decimalValueForFinal) : "").draw();
        ...
        if (TotalFor100Percentage != "" && TotalFor100Percentage != 'undefined' && TotalFor100Percentage != null) {
            term1AndTerm2ScoreTotal = ((parseFloat(totalScoreFor100Percent) + parseFloat(TotalFor100Percentage)) / 2).toFixed(decimalValueForFinal);
        }
        else {
        ...
        table.cell(rowNumber - 1, TotalFor50PercentageColumnIndex).data((totalScoreFor100Percent != "") ? (parseFloat(totalScoreFor100Percent) / 2).toFixed(decimalValueForFinal) : "").draw();
        TotalFor100Percentage = table.cell(rowNumber - 1, TotalFor100PercentageColumnIndex).data();
        Term2TotalFor100ercentage = table.cell(rowNumber - 1, Term2TotalFor100PercentageColumnIndex).data();
        if (Term2TotalFor100ercentage != "" && Term2TotalFor100ercentage != 'undefined' && Term2TotalFor100ercentage != null) {
            term1AndTerm2ScoreTotal = ((parseFloat(totalScoreFor100Percent) + parseFloat(Term2TotalFor100ercentage)) / 2).toFixed(decimalValueForFinal);
        }
        else {
            term1AndTerm2ScoreTotal = totalScoreFor100Percent;
        }
    ...
    else { term1AndTerm2TotalGrade = GetGradeLabel(term1AndTerm2ScoreTotal, rowNumber); term1AndTerm2ScoreTotal = parseFloat(term1AndTerm2ScoreTotal).toFixed(decimalValueForFinal) }
...
function GetHeaderContent(htmlTemplate, response) {
    ...
    if (response.Assessments != "undefined") {
        ...
        $.each(response.Assessments, function (index, val) {
            ...
            //console.log(AssessmentMaxScoreHeaderText);
...
function GetCoursesForImportGrade(assessmentTypeName) {
    console.log("assessmentTypeName" + assessmentTypeName);

    if (assessmentTypeName == "GetBehaviorLabel") {
        $("#titleCourseForImportGrade").html("นำเข้าข้อมูลคะแนนคุณลักษณะอันพึงประสงค์");
    }
    else if (assessmentTypeName == "GetReadWrite") {
        $("#titleCourseForImportGrade").html("นำเข้าข้อมูล อ่าน คิด วิเคราะห์และเขียน");
    }
    else if (assessmentTypeName == "GetSamattana") {
        $("#titleCourseForImportGrade").html("นำเข้าข้อมูล สมรรถนะ");
    }
...
function BindData(response) {
    ...
    $("#chkGradeDicimalForFinal").prop("checked", (response.GradeDicimalForFinal == "1") ? true : false);
    if (LevelName != null && LevelName != "" && LevelName != "ปวช." && LevelName != "ปวส." && LevelName != "มัธยมศึกษา") {
    ...
    $("#lblGradeDicimalForFinal").html(languageContent[0].lblGradeDicimalForFinal);
    ...
    $.each(assessmentColumns, function (index, Value) {
        $.each(Value.Columns, function (colIndex, colIndexValue) {
            if (selectedColIndex != colIndexValue) {
                ...
                if (score != "" && score != null && $.isNumeric(score)) {
...
function GetSumOfStudentScoreForCorrection(assessmentTypeName, rowIndex) {
    ...
    $.each(assessmentColumns, function (index, Value) {
        ...
        $.each(Value.Columns, function (colIndex, colIndexValue) {
            ...
            if (score != "" && score != null && score != "#REF!" && $.isNumeric(score)) {
                totalScore += parseFloat(score);
            }
        });
    });
        ...
        reader.onload = function (e) {
            ...
            workbook.SheetNames.forEach(function (sheetName) {
                ...
                if (sheetName == "สำหรับdev1") {
                    ...
                    for (var start = 1; start <= 20; start++) {
                        ...
                        if (assessment != undefined && assessment != null && assessment.length > 0) {
                            //console.log(assessment[0].AssessmentMaxScore);
                            //console.log(assessmentMaxScore["maxGrade" + start]);
                            //console.log(data[0]["maxGrade" + start]);
                            //console.log("------------------");
                            if (isvalidMaxScore && assessment[0].AssessmentMaxScore != data[0]["maxGrade" + start] && assessment[0].AssessmentMaxScore != "" && data[0]["maxGrade" + start] != "") {
                        ...
                        if (assessment != undefined && assessment != null && assessment.length > 0) {
                            ...
                            if (isvalidMaxScore && assessment[0].AssessmentMaxScore != data[0]["maxCheewat" + start] && assessment[0].AssessmentMaxScore != "" && data[0]["maxCheewat" + start] != "") {
                                isvalidMaxScore = false;
                            }
                    ...
                    for (var start = 1; start <= 10; start++) {
                        ...
                        if (assessment != undefined && assessment != null && assessment.length > 0) {
                            ...
                            if (isvalidMaxScore && assessment[0].AssessmentMaxScore != data[0]["maxMid" + start] && assessment[0].AssessmentMaxScore != "" && data[0]["maxMid" + start] != "") {
                                isvalidMaxScore = false;
                            }

                            //console.log(assessment[0].AssessmentMaxScore);
                            //console.log(assessmentMaxScore["maxMid" + start]);
                            //console.log(data[0]["maxMid" + start]);
                            //console.log("------------------");
                        ...
                        if (assessment != undefined && assessment != null && assessment.length > 0) {
                            ...
                            //console.log(assessment[0].AssessmentMaxScore);
                            //console.log(assessmentMaxScore["maxFinal" + start]);
                            //console.log(data[0]["maxFinal" + start]);
                            //console.log("------------------");

                            if (isvalidMaxScore && assessment[0].AssessmentMaxScore != data[0]["maxFinal" + start] && assessment[0].AssessmentMaxScore != "" && data[0]["maxFinal" + start] != "") {
                                isvalidMaxScore = false;
                            }
                        ...
                        if (assessment != undefined && assessment != null && assessment.length > 0) {
                            ...
                            if (isvalidMaxScore && assessment[0].AssessmentMaxScore != data[0]["maxBehavior" + start] && assessment[0].AssessmentMaxScore != "" && data[0]["maxBehavior" + start] != "") {
                                isvalidMaxScore = false;
                            }
                    ...
                    for (var start = 1; start <= 5; start++) {
                        ...
                        if (assessment != undefined && assessment != null && assessment.length > 0) {
                            if (isvalidMaxScore && assessment[0].AssessmentMaxScore != data[0]["maxReadWrite" + start] && assessment[0].AssessmentMaxScore != "" && data[0]["maxReadWrite" + start] != "") {
                                isvalidMaxScore = false;
                            }
                        ...
                        if (assessment != undefined && assessment != null && assessment.length > 0) {
                            ...
                            if (isvalidMaxScore && assessment[0].AssessmentMaxScore != data[0]["maxSamattana" + start] && assessment[0].AssessmentMaxScore != "" && data[0]["maxSamattana" + start] != "") {
                                isvalidMaxScore = false;
                            }
                    ...
                    var fRatioQuizPassExcel = (data[0].fRatioQuizPass % 5 == 0 && data[0].fRatioQuizPass != 'undefined' && data[0].fRatioQuizPass != "") ? data[0].fRatioQuizPass : "-1";
                    ...
                    else if ($("#ddlPassingCutOffPercentage").val() != fRatioQuizPassExcel && $("#ddlPassingCutOffPercentage").val() != "-1") {
                        isvalidRatio = false;
                    }
                ...
                if (check > 0 && sheetName == "สำหรับdev2") {
                            ...
                            if (IsMatching.length > 0) {
                                ...
                                for (var start = 1; start <= 10; start++) {
                                    ...
                                    if (assessment != undefined && assessment != null && assessment.length > 0 && data[x]["scoreFinal" + start] != null && data[x]["scoreFinal" + start] != 'undefined' && data[x]["scoreFinal" + start] != "") {
                                        console.log("Score Final - " + data[x]["scoreFinal" + start]);
                                        console.log("Max Score - " + gradeImportFromExcelRequest.AssessmentMaxScore["maxFinal" + start]);
                                ...
                                var readWrite;
                                if (data[x].getReadWrite != null && data[x].getReadWrite != "") { readWrite = data[x].getReadWrite; readcount++; } else readWrite = "";
                    ...
                    console.log("IsValidScore" + IsValidScore);
                    console.log("isvalidMaxScore" + isvalidMaxScore);
                    console.log(notfound);
                    if (isvalidRatio && IsValidScore && isvalidMaxScore) {
...
function ConvertToFloat(value) {
    return (value == "" || value == null || value == 'undefined') ? 0 : parseFloat($.trim(value.toString()));
}
