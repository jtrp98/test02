...
var _currentPage_type2 = function () {
    ...
    var modelInit = function () {
        ...
        function generateItem() {
               ...
               <tr style=\"border: 1px solid black;border-collapse:collapse\">   \
                   ...
                   <td style=\"border: 1px solid black; border-collapse: collapse;text-align:right;\">   \
                      <div class=\"form-group\"> \
                        <div class=\"col-md-9 text-left\" style=\"font-size: 12px;width: 75%;\"><span name=\"textTH\"></span><br/><span name=\"textENG\"></div>\
                        <div class=\"col-md-3 text-right\" style=\"padding: 5px;\"><b style=\"font-size:18px;\"> รวมเป็นเงิน/Total</b></div>\
                      </div> \
                   </td> \
                <td style=\"border: 1px solid black;border-right: 1px solid black; border-collapse: collapse;padding:5px;text-align:center;\">   \
                      <span class=\"product_grand_total\"style=\"font-size:18px;\"> </span> \
            ...
            $("#tb-products-2 tbody").append(itemTemplate);
