    ...
    function setLabel(formdata) {
        ...
        switch (formdata.ReportType) {
            case "1"://week
                ...
                break;
            case "2"://month
                let dateRange = "01/" + $("#ddl-month").val() + "/" + $("#ddl-year").val();
                var startDate = parseInt(moment(dateRange, 'DD/MM/YYYY').startOf('month').format('D'));
                var endDate = parseInt(moment(dateRange, 'DD/MM/YYYY').endOf('month').format('D'));
                var filterMonth = parseInt(moment(dateRange, 'DD/MM/YYYY').endOf('month').format('MM'));
                filterYear = parseInt(moment(dateRange, 'DD/MM/YYYY').endOf('month').format('YYYY')) + 543;
