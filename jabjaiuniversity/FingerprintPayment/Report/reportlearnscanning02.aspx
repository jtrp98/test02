<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true"
    CodeBehind="reportlearnscanning02.aspx.cs" Inherits="FingerprintPayment.Report.reportlearnscanning02" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../app/Reports/ReportLearnScanningJS/ReportLearnScanning02JS.js" type="text/javascript"></script>
    ...
    <div class="report-container">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <div class="col-md-7 col-sm-6">
                    <select id="plane" name="plane" class="form-control"></select>
                </div>
            </div>
        </div>
        <div class="row">
