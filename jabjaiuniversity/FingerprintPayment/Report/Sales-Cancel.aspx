<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true"
    CodeBehind="Sales-Cancel.aspx.cs" Inherits="FingerprintPayment.Report.Sales_Cancel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Script/Sales-cancel.js?d=<%= DateTime.Now.ToString("ddMMyyyyHHmmssss") %>" type="text/javascript"></script>
        ...
        <div class="row ">
            ...
            <div class="form-group col-sm-6">
                ...
                <div class="col-md-7 col-sm-6">
                    ...
                    <input type="text" class='form-control' id="txtemployees" placeholder="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M105008") %>" />
                </div>
            </div>
        </div>
