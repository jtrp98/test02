<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true"
    CodeBehind="reportlearnscanning03.aspx.cs" Inherits="FingerprintPayment.Report.reportlearnscanning03" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../app/Reports/ReportLearnScanningJS/ReportLearnScanning03JS.js" type="text/javascript"></script>
    ...
    <div class="report-container">
        ...
        <div class="row student">
            ...
            <div class="form-group col-sm-6">
                ...
                <div class="col-md-7 col-sm-6">
                    <asp:DropDownList ID="semister" runat="server" class="form-control" disabled>
        ...
        <div class="row student">
            ...
            <div class="form-group col-sm-6">
                ...
                <div class="col-md-7 col-sm-6">
                    <asp:DropDownList ID="ddlSubLV2" runat="server" class="form-control" disabled>
                    </asp:DropDownList>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-sm-6">
                ...
                <div class="col-md-7 col-sm-6">
                    <input type="text" id="txtstart" readonly="readonly" class="form-control datepicker" />
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                ...
                <div class="col-md-7 col-sm-6">
                    <select id="plane" name="plane" class="form-control" disabled></select>
                </div>
            </div>
            <div class="form-group col-sm-6">
                <%--    <label class="col-md-5 col-sm-6 control-label">
            ...
            <div class="col-sm-12">
                <fieldset>
                    ...
                    <table id="example" class="table table-condensed table-bordered table-show-result"
                        ...
                        <thead id="myHeader" class="hidden"></thead>
                        <tbody id="myTable">
                        </tbody>
                    </table>
                </fieldset>
