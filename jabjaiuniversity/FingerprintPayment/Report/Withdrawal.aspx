<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true"
    CodeBehind="Withdrawal.aspx.cs" Inherits="FingerprintPayment.Report.Withdrawal" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Script/Withdrawalmoney.js?d=<%= DateTime.Now.ToString("ddMMyyyyHHmmssss") %>" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        var Report_Withdrawalmoney = new report_Withdrawalmoney();
        ...
        {
            jsonData += (string.IsNullOrEmpty(jsonData) ? "" : ",") + "{ \"lable\": \"" + data.lable + "\", \"mobile\": " + data.mobile + ",\"website\":" + data.website + " }";
        }
        %>
        ...
        function Chart_Reports(header_text, report_data) {
            ...
            var bar = new Morris.Line({
                ...
                labels: ['<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M603075") %>', '<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M603076") %>'],
                hideHover: 'auto',
                parseTime: false,
                axes: true
            });
        ...
        function SearchData() {
            ...
            var data = { "sort_type": $("#sort_type").val(), "dStart": dStart, "dEnd": dEnd, "emp_id": $("#txtemployees_id").val() };
            Report_Withdrawalmoney.search_Data = data;

            $("body").mLoading();
            if ($("#sort_type").val() != "3" || data.dEnd != data.dStart) {
                PageMethods.reports_data(data, function (e) {
                    console.log(e.data);
                    Report_Withdrawalmoney.reports_data = e;
                    Report_Withdrawalmoney.RenderHtml("example", false);
                });
            } else {
                PageMethods.reports_detail(data, function (e) {
                    console.log(e.data);
                    Report_Withdrawalmoney.reports_data = e;
                    Report_Withdrawalmoney.RenderHtml_Detail("example", false);
                });
            }
        }
        ...
        function qurey_month(dStart) {
            var data = { "sort_type": 1, "dStart": getDate(dStart), "emp_id": $("#txtemployees_id").val() };
        ...
        function qurey_data(sort_type, dStart, dEnd) {
            var data = { "sort_type": sort_type, "dStart": dStart, "dEnd": dEnd, "emp_id": $("#txtemployees_id").val() };
            Report_Withdrawalmoney.search_Data = data;
            $("body").mLoading();
            PageMethods.reports_data(data, function (e) {
                console.log(e.data);
        ...
        function qurey_detail(dStart) {
            var data = { "sort_type": 3, "dStart": getDate(dStart), "emp_id": $("#txtemployees_id").val() };
            Report_Withdrawalmoney.search_Data = data;
            $("body").mLoading();
            PageMethods.reports_detail(data, function (e) {
                console.log(e.data);
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="col-md-12" id="table_0">
                <table>
                    <tr>
                        ...
                        <td style="padding: 5px 5px;"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M603075") %></td>
                        <td>
                            <div class="col-md-12" style="background-color: #337AB7; min-height: 30px; border-radius: 30px;"></div>
                        </td>
                        <td style="padding: 5px 5px;"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M603076") %></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <div class="full-card box-content report-container" id="content_1" style="display: none;">
        <div class="row student">
            <div class="form-group col-sm-6">
                <label class="col-md-5 col-sm-6 control-label">
                    <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M603077") %></label>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2">
                <div class="btn btn-success button-custom" id="exportfile" onclick="Report_Withdrawalmoney.export_excel()">Export File</div>
            </div>
        </div>
