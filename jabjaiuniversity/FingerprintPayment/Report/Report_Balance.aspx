<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report_Balance.aspx.cs" MasterPageFile="~/mp.Master" Inherits="FingerprintPayment.Report.Report_Balance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Script/RP_Balance.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        var RP_Balance = new RPBalanceStudent();
        var searchBalance = [];

        function SearchData() {
            var sUbLV = $('select[id*=ddlsublevel').val()
            var sUbLV2 = $('select[id*=ddlSubLV2').val()
            var rRport_tYpe = parseInt($('select[id*=report_type').val());
            var TxTName_Emp = $('#TextName_Emp').val();
            var dStart = $('#TxTdateStart').val();
            var numberYear = $('select[id*=ddlYear').val()
            var data = {
                sUbLV_Id: sUbLV,
                sUbLV2_Id: sUbLV2,
                rRport_tYpe: rRport_tYpe,
                EmpFullName: TxTName_Emp,
                dStart: getDate(dStart),
                numberYear: numberYear
            };
            searchBalance = data;
            $("body").mLoading();
            PageMethods.Report_Student_Balance(data, function (e) {
                console.log(e.data);
                RP_Balance.Report_Student_Balance = e;
                RP_Balance.RenderHtml_Student_Balance("example", false);
            });
        }
        ...
        function showreport_type() {
            switch ($("#report_type").val()) {
                case "3": $(".SortStd").hide(); $(".SortEmp").hide();
                    $('#TextName_Emp').val('');
                    $("#ctl00_MainContent_ddlsublevel").val('');
                    $("#ctl00_MainContent_ddlSubLV2").val('');
                    break;

                case "0": $(".SortEmp").hide(); $(".SortStd").show();
                    $('#TextName_Emp').val('');
                    break;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="full-card box-content">
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                <label class="col-md-3 col-sm-6 control-label"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M107032") %> :</label>
                <div class="col-md-7 col-sm-6">
                    <select id="report_type" class="form-control">
                        ...
                        <option value="4"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M206367") %></option>
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                <label class="col-md-3 col-sm-6 control-label"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M206248") %> :</label>
                <div class="col-md-7 col-sm-6">
                    <input type="text" class='form-control datepicker' id="TxTdateStart" readonly="readonly" />
                </div>
            </div>
            <div class="form-group col-sm-6">
            </div>
        ...
        <div class="row hidden SortStd">
            <div class="form-group col-sm-6">
                <label class="col-md-3 col-sm-6 control-label"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M603047") %></label>
                <div class="col-md-7 col-sm-6">
                    <input type="text" class='form-control' id="TextID_Student" style="display: none;" />
                    <input type="text" class='form-control' id="TextName_Student" />
                </div>
            </div>
            <div class="form-group col-sm-6">
            </div>
        ...
        <div class="row SortEmp">
            <div class="form-group col-sm-6">
                <label class="col-md-3 col-sm-6 control-label"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M603046") %></label>
                <div class="col-md-7 col-sm-6">
                    <input type="text" class='form-control' id="TextID_Emp" style="display: none;" />
                    <input type="text" class='form-control' id="TextName_Emp" />
                </div>
            </div>
            <div class="form-group col-sm-6">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2">
                <div class="btn btn-success button-custom" id="exportfile" onclick="RP_Balance.export_excel()">Export File</div>
            </div>
        </div>
