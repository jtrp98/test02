<%@ Page Title="" Language="C#" MasterPageFile="~/Material2.Master" AutoEventWireup="true"
    CodeBehind="ResignStudent.aspx.cs" Inherits="FingerprintPayment.Report.ResignStudent" %>
    ...
    <script>
        ...
        function SearchData(t) {
            ...
            if (t == 'data') {
                ...
                $("body").mLoading();             
                PageMethods.GetData1(YTF.GetTermID(), function (response) {
                    $("#result-wrapper").html('');
                    if (response.length > 0) {
                        ...
                        response.forEach(r => {
                            ...
                            d.forEach(i => {
                                ...
                                var tr = '<tr id=' + i.sID + '>\
                                    ...
                                    '<td style="text-align: center">' + i.moveOutDate +
                                    '<td style="text-align: center">' + i.moveOutReason
                                    ;
                        ...
                        var tr = '<tr><td style="text-align: center" colspan=7><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102035") %>';
                ...
                var dt = new Date();
                var file_name = '<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M104062") %>_' + dt.format("ddMMyyyyHHmmssss") + '.xls';

                xhr = new XMLHttpRequest();

                xhr.open("POST", "/Report/ResignStudent.aspx/ExportExcel1", true);
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="text-muted" style="font-size: small;">
                <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M104062") %>
            </p>
        </div>
    </div>
                                ...
                                <table id="template1" class=" table-hover dataTable" width="100%" style="margin:0 5px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 20%; text-align: center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M105031") %></th>
                                            ...
                                            <th style="width: 15%; text-align: center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102097") %></th>
                                            <th style="width: 15%; text-align: center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M104065") %></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <td style="text-align:right; border-bottom: 2px solid #000;" colspan="7">
                                                <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M104066") %>  <span id="stdAmount"></span> <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101322") %>
                                            </td>
                                        </tr>
                                         <tr>
