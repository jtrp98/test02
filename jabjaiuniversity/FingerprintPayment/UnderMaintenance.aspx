<%@ Page Title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M00992") %>" MasterPageFile="~/Material2.Master" Language="C#" AutoEventWireup="true" CodeBehind="UnderMaintenance.aspx.cs" Inherits="FingerprintPayment.UnderMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card ">
        <div class="row">
            ...
            <div class="col-md-12 text-center " style="padding: 10px">
                <h2 style="color:#ed8229"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M206134") %></h2>
            </div>
            <%--<div class="col-md-12 text-center " style="padding: 10px">
