<%@ Page Title="" Language="C#" MasterPageFile="~/Material2.Master"
    CodeBehind="StockAdd.aspx.cs" Inherits="FingerprintPayment.Stockadd" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SaveForm(isDone) {
            ...
            var stockList = [];
            $('#template1 tbody tr:visible').each(function (i) {
                var $tr = $(this);
                var item = {};
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="txtInvNo" id="txtInvNo" class="form-control" placeholder="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M601075") %>" />
                            </div>
                            <div class="col-sm-1"></div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group ">
                                    <input type="text" name="txtInvDate" id="txtInvDate" class="datepicker form-control" value="" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="txtPONo" id="txtPONo" class="form-control" placeholder="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M601077") %>" />
                            </div>
                            <div class="col-sm-1"></div>
                            <label class="col-sm-1 col-form-label text-left"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103166") %></label>
                            <div class="col-sm-3">
                                <div class="form-group ">
                                    <input type="text" name="txtPODate" id="txtPODate" class="datepicker form-control" value="" />
                                    <span class="form-control-feedback" style="color: #000; opacity: 1;">
                                        <i class="material-icons">event</i>
                                    </span>
                                </div>
