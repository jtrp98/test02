...
{
    /// <summary>
    /// Summary description for CancelTx
    /// </summary>
    public class CancelTx : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            bool isSuccess = true;
            string message = "Cancel QRCode Successfully!";

            int schoolID = 0;
            string PartnerTxnUid = "";
            int userID = 0;

            ResponseCancelTx responseData = new ResponseCancelTx();
            ...
            try
            {
                ...
                using (JabJaiMasterEntities masterEntities = Connection.MasterEntities(ConnectionDB.Read))
                {
                    ...
                    // Cancel Tx
                    RequestBodyCancelTx requestBodyCancelTx = null;
                    ...
                    using (JabJaiEntities schoolEntities = new JabJaiEntities(Connection.StringConnectionSchool(schoolID, ConnectionDB.Read)))
                    {
                        ...
                        if (kPromptPayTransaction != null)
                        {
                            ...
                            requestBodyCancelTx = new RequestBodyCancelTx
                            {
                            ...
                            var jsonRequestBody = JsonConvert.SerializeObject(requestBodyCancelTx);


                            // Cancel QRCode
                            client.BaseUrl = new Uri(kbankUrl + "/v1/qrpayment/cancel");
                            ...
                            responseData = JsonConvert.DeserializeObject<ResponseCancelTx>(response.Content);

                            var cancelTransaction = schoolEntities.KPromptPayTransactions.Where(w => w.PartnerTxnUID == responseData.PartnerTxnUID).FirstOrDefault();
                            if (cancelTransaction != null)
                            {
                                cancelTransaction.ErrorCode = responseData.ErrorCode;
                                cancelTransaction.ErrorDesc = responseData.ErrorDesc;
                                cancelTransaction.StatusCode = responseData.StatusCode;
            ...
            catch (Exception err)
            {
                ...
                fcommon.InsertLog(string.Format("insert into [dbo].[tb_apilog] ([info]) values ('Error Message:[PaymentGateway/KBank/KBankPromptPay/CancelTx.ashx]:{0}')", err.Message.Replace("'", "")));
                ...
                notify.LineSBErrorSend(new LINENotifyDATA
                {
                    ...
                    URL = "https://dev.schoolbright.co/PaymentGateway/KBank/KBankPromptPay/CancelTx.ashx",
                    Error_Method = "KBankPromptPay - Cancel QRCode"
                }, err);
    ...
    public class RequestBodyCancelTx
    {
