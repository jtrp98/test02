...
{
    /// <summary>
    /// Summary description for VoidTx
    /// </summary>
    public class VoidTx : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            ResponseVoidTx responseData = new ResponseVoidTx();
            ...
            try
            {
                ...
                using (JabJaiMasterEntities masterEntities = Connection.MasterEntities(ConnectionDB.Read))
                {
                    ...
                    // Void Tx
                    RequestBodyVoidTx requestBodyVoidTx = null;
                    ...
                    using (JabJaiEntities schoolEntities = new JabJaiEntities(Connection.StringConnectionSchool(schoolID, ConnectionDB.Read)))
                    {
                        ...
                        if (kPromptPayTransaction != null)
                        {
                            ...
                            requestBodyVoidTx = new RequestBodyVoidTx
                            {
                            ...
                            var jsonRequestBody = JsonConvert.SerializeObject(requestBodyVoidTx);


                            // Void QRCode
                            client.BaseUrl = new Uri(kbankUrl + "/v1/qrpayment/void");
                            ...
                            responseData = JsonConvert.DeserializeObject<ResponseVoidTx>(response.Content);

                            var voidTransaction = schoolEntities.KPromptPayTransactions.Where(w => w.PartnerTxnUID == responseData.PartnerTxnUID).FirstOrDefault();
                            if (voidTransaction != null)
                            {
                                voidTransaction.ErrorCode = responseData.ErrorCode;
                                voidTransaction.ErrorDesc = responseData.ErrorDesc;
                                voidTransaction.StatusCode = responseData.StatusCode;
            ...
            catch (Exception err)
            {
                ...
                fcommon.InsertLog(string.Format("insert into [dbo].[tb_apilog] ([info]) values ('Error Message:[PaymentGateway/KBank/KBankPromptPay/VoidTx.ashx]:{0}')", err.Message.Replace("'", "")));
                ...
                notify.LineSBErrorSend(new LINENotifyDATA
                {
                    ...
                    URL = "https://dev.schoolbright.co/PaymentGateway/KBank/KBankPromptPay/VoidTx.ashx",
                    Error_Method = "KBankPromptPay - Void QRCode"
                }, err);
    ...
    public class RequestBodyVoidTx
    {
