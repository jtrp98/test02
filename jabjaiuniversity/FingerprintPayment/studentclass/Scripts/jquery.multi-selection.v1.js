...
(function ($) {
    $.fn.jQueryMultiSelection = function (options) {
        ...
        var _opts = $.extend({
            ...
            htmlMoveAllRight: "ทั้งหมด <i class=\"fa  fa-angle-double-right\"></i>",
            htmlMoveSelectedRight: "<i class=\"fa  fa-angle-double-right\"></i>",
            htmlMoveAllLeft: "&lsaquo;&lsaquo;",
            htmlMoveSelectedLeft: "<i class=\"fa  fa-angle-double-left\"></i>",
            htmlDelete: "Delete",
            htmlMoveUp: "Up",
            htmlMoveDown: "Down",
        }, options);
