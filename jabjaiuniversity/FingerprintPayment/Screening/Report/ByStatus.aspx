<%@ Page Title="" Language="C#" MasterPageFile="~/Material2.Master" AutoEventWireup="true" CodeBehind="ByStatus.aspx.cs" Inherits="FingerprintPayment.Screening.Report.ByStatus" %>
        ...
        function SearchData(t) {
            ...
            if (t == 'data') {
                ...
                var dt = $('#template1').DataTable({
                    ...
                    "lengthChange": false,
                    ajax: {
                        url: "/Screening/Report/ByStatus.aspx/LoadData",
                        type: "POST",
                    ...
                    "columns": [
                        ...
                        { "title": "<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M107007") %>", data: 'Room', "class": "text-center", "width": "15%" },
                        { "title": "<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M105031") %>", data: 'FullName', "width": "25%", "class": "text-center" },
                        {
                            "title": "<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101021") %>", data: 'Status', "width": "10%", "class": "text-center",
                            "mRender": function (data, type, row) {

                                if (row.Status == '0') {
                                    return "<span class='text-gray'><span class='material-icons'>circle</span></span>";
                                }
                                else {
                                    return "<span class='text-success'><span class='material-icons'>check_circle</span></span>";
                                }
                ...
                xhr.open("POST", "/Screening/Report/ByStatus.aspx/ExportExcel", true);
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="text-muted" style="font-size: small;">
                <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M307002") %>
            </p>
        </div>
    </div>
                    ...
                    <div class="card-body ">
                        ...
                        <div calss="row">
                            <div class="col-md-12 " style="">
                                ...
                                <br />
                                <span>
                                    <strong><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M307004") %> :</strong>
                                    ...
                                    <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M304019") %> 
