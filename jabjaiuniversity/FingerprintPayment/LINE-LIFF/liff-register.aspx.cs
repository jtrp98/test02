...
namespace FingerprintPayment.LINE_LIFF
{
    public partial class liff_register : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                //string ssid = Request.QueryString["liff.state"];
                //SSID = HttpUtility.ParseQueryString(ssid).Get("ssid");
