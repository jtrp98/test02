<%@ Page Title="" Language="C#" MasterPageFile="~/Material2.Master" AutoEventWireup="true" CodeBehind="NewsList.aspx.cs" Inherits="FingerprintPayment.Message.NewsList" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="text-muted" style="font-size: small;">
                <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M01561") %> &rsaquo; <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M701015") %>
            </p>
        </div>
    </div>
                                    ...
                                    <table id="tableData" class="table table-no-bordered" cellspacing="0" width="100%" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 11%" class="disabled-sorting text-center">
                                                    <button id="btnNewsNew" class="btn btn-success btn-sm" role="button" aria-pressed="true" style="margin: -21px -9px -9px -9px; width: 111px;">
                                                        <span class="btn-label">
                                                            <i class="material-icons">add</i>
                                                        </span>
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M401011") %>
                                                    </button>
                                                </th>
                                                <th></th>
                                            </tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#btnNewsNew').click(function () {

                window.location.href = 'NewsForm.aspx?nid=0';
            ...
            $('#tableData').on('click', '.view-data', function () {
                ...
                window.location.href = 'NewsView.aspx?nid=' + $(this).data('nid');
