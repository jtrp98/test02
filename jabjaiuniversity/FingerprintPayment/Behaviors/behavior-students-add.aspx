<%@ Page Title="" Language="C#" MasterPageFile="~/mppopup.Master" AutoEventWireup="true"
    CodeBehind="behavior-students-add.aspx.cs" Inherits="FingerprintPayment.Modules.TimeAttendance.behavior_students_add" 
    EnableViewState="true" Async="true" %>
            ...
            <ContentTemplate>
                ...
                <div class="row planadd-row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <input class="form-control" type="text" id="studentID" runat="server" readonly="true" />
                        </div>
                ...
                <div class="row planadd-row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <input class="form-control" type="text" id="studentName" runat="server" readonly="true"/>
                        </div>
                ...
                <div class="row planadd-row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <input class="form-control" type="text" id="Note" runat="server" />
                        </div>
