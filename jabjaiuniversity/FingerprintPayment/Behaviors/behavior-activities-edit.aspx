<%@ Page Title="" Language="C#" MasterPageFile="~/mppopup.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="behavior-activities-edit.aspx.cs"  Async="true"
    Inherits="FingerprintPayment.Modules.TimeAttendance.behavior_activities_edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //tabtimetype($('input[id*=txtPlaneID]').val(), 'divmain', 'myTabContent');
        });
        ...
        function getlevel(sid, _index, divsub) {
            ...
            $.ajax({
                ...
                success: function (objlevel, status) {
                    ...
                    tabHTML += '<table class="table table-striped"><tr style="background:#FF8A65;"><td style="width:70%"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132570") %></td><td style="width:15%"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132031") %></td></tr>';
        ...
        function getsublevel(sid) {
            ...
            $.ajax({
                type: "POST",
                url: "/App_Logic/dataGeneric.ashx?ID=" + sid + "&mode=listPlane&splane=" + _nhol,
                cache: false,
                contentType: 'application/json;',
                success: function (objlevel, status) {
                    var tabHTML = "";
            ...
            <ContentTemplate>
                ...
                <div class="row planadd-row">
                    <div class="col-xs-12">
                        <div class="col-xs-3">
                            <label>
                                <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M131227") %></label>
                        </div>
                        <div class="col-xs-8">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-4">
                            <asp:DropDownList ID="Type" runat="server" class="form-control">
                                <asp:ListItem Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M01256") %>" Value="0" Selected="True" />
                                <asp:ListItem Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M01816") %>" Value="1" />
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>
                <div class="row planadd-row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <input class="form-control" type="number" id="Score" runat="server" onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
                        </div>
                ...
                <div class="row text-center planadd-row">
                    <div class="col-xs-12 button-segment">
                        <asp:Button CssClass="btn btn-primary global-btn" ID="btnEdit" runat="server"
                            Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132032") %>" />
