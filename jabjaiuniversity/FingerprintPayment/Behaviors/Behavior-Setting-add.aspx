<%@ Page Title="" Language="C#" MasterPageFile="~/mppopup.Master" AutoEventWireup="true"
    CodeBehind="Behavior-Setting-add.aspx.cs" Inherits="FingerprintPayment.Behavior_Setting_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="full-card text-center planeadd-container">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <div class="col-xs-12">
                <div class="col-xs-6">
                    <label><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132039") %></label></div>
                <div class="col-xs-4">
                    <asp:DropDownList ID="Type" runat="server" class="form-control">
                        <asp:ListItem Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M405023") %>" Value="1" Selected="True" />
                        <asp:ListItem Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M105012") %>" Value="2" />                        
                    </asp:DropDownList>
                </div>
            </div>
        </div>
                <div class="row planadd-row">
                    <div class="col-xs-12">
                        <div class="col-xs-6">
                            <label><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132040") %></label>
                        </div>
                        <div class="col-xs-4">
                            <input class="form-control" type="number" id="Score" runat="server" />
                        </div>
