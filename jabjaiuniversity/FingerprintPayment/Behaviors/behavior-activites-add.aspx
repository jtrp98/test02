<%@ Page Title="" Language="C#" MasterPageFile="~/mppopup.Master" AutoEventWireup="true"
    CodeBehind="behavior-activites-add.aspx.cs" Inherits="FingerprintPayment.behavior_activites_add" Async="true" %>
            ...
            <ContentTemplate>
                ...
                <div class="row planadd-row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-4">
                            <input class="form-control" type="number" id="Score" runat="server" min="0" onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
                        </div>
