<%@ Page Title="" Language="C#" MasterPageFile="~/Material2.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="OnlineLearnAdd.aspx.cs"
    Inherits="FingerprintPayment.ClassOnline.OnlineLearnAdd" Async="true" %>
                                ...
                                <ContentTemplate>
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlGroup" runat="server" AutoPostBack="true" required
                                            ...
                                            DataTextField="Text"
                                             data-width="100%"
                                            DataValueField="Value" CssClass="chosen-selectx -custom-fixx selectpicker1 " OnSelectedIndexChanged="ddlGroup_SelectedIndexChanged" data-style="select-with-transition" data-live-search="true" >
                                        </asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlType" runat="server"
                                            ...
                                            DataTextField="Text"
                                             data-width="100%"
                                            DataValueField="Value" CssClass="chosen-selectx choose-type1 selectpicker1 " data-style="select-with-transition" data-live-search="true" >
                                    ...
                                    <div class="form-group chosen-wrap-here" id="selectType1">
                                        ...
                                        <asp:ListBox ID="ddlLevel" runat="server" SelectionMode="Multiple"
                                            ...
                                            DataTextField="Text"
                                             data-width="100%"
                                            DataValueField="Value" CssClass="chosen-selectx -custom-fixx selectpicker1 " data-style="select-with-transition" data-live-search="true" ></asp:ListBox>
                                    </div>
                            ...
                            <%-- <div id="displayDate-wrapper" class="form-group" style="display: none">
                                <div class="col-md-8" style="padding-left: 0; padding-right: 5px;">
                                    <div class='input-group date' id='divDisplayDate'>
                                        <asp:TextBox runat="server" ID="txtDisplayDate" ClientIDMode="Static" CssClass="form-control bs-datepicker --date-validate datepicker" Style="" autocomplete="off" />
