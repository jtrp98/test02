<%@ Page Title="" Language="C#" MasterPageFile="~/Material2.Master" EnableEventValidation="true" AutoEventWireup="true" CodeBehind="OnlineWorkEdit.aspx.cs"
    Inherits="FingerprintPayment.ClassOnline.OnlineWorkEdit" Async="true" %>
                    ...
                    <div class="row">
                        <div class="col-md-7 vert-line">
                            <div class="form-group">
                                <label for=""><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M403005") %></label>
                            ...
                            <div id="attachlink" class="form-groupx">
                                <label for=""><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M206357") %></label> 
                        ...
                        <div class="col-md-4 ">
                                ...
                                <ContentTemplate>
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlGroup" runat="server" AutoPostBack="true" 
                                            ...
                                            DataTextField="Text"
                                            DataValueField="Value" CssClass="chosen-selectx selectpicker1  -custom-fixx" 
                                             data-width="100%"
                                    ...
                                    <div class="form-group chosen-wrap-here" id="selectType1">
                                        ...
                                        <asp:ListBox ID="ddlLevel" runat="server" SelectionMode="Multiple"
                                            ...
                                            DataValueField="Value" 
                                             data-width="100%"
                                             data-style="select-with-transition" data-live-search="true"
                                            CssClass="chosen-selectx selectpicker1 -custom-fixx"></asp:ListBox>
                                    </div>
                            ...
                            <%--                            <div class="form-group">
                                <label for=""><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M00116") %></label>
                             
                                <div class='input-group date' id='divDStart'>
                                    <asp:TextBox runat="server" ID="txtStart" CssClass="form-control --date-validate  bs-datepicker" MaxLength="10" placeholder="" Style="background: white;" required autocomplete="off" />
                            ...
                            <%--  <div class="form-group">
                    <label for=""><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132074") %></label>
                    <div class="input-group" style="">
                        <asp:TextBox runat="server" ID="txtEnd" CssClass="form-control datepicker" placeholder="" Style="" data-date-format="dd/mm/yyyy" />
                        <span class="input-group-addon" id="basic-addon2"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></span>
                    </div>

                </div>
                <div class="form-group">
                    <label for=""><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M131075") %></label>
                    <div class="input-group" style="">
                        <asp:TextBox runat="server" ID="txtNotiDate" CssClass="form-control datepicker" placeholder="" Style="" data-date-format="dd/mm/yyyy" />
                        <span class="input-group-addon" id="basic-addon2"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></span>
                    </div>

                </div>
                <div class="form-group">
                    <label for=""><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132075") %></label>
                    <asp:TextBox runat="server" ID="txtNotiTime" TextMode="Time" CssClass="form-control" placeholder="" Style="" />
                </div>--%>


                            <div class="form-group">
                                <label for=""><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M204046") %></label>
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlDisplay" runat="server"
                                    ClientIDMode="Static"
                                    DataTextField="Text"
                                    DataValueField="Value" CssClass="chosen-selectx selectpicker1" 
                                     data-width="100%"
                                     data-style="select-with-transition" data-live-search="true">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group text-center">
                                ...
                                <% }%>
                                <%-- <asp:Button Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101378") %>" runat="server" ID="btnBack" CssClass="btn btn-default search-btn" OnClick="btnBack_Click" />--%>
   ...
   <%-- <script src="js/chosen.jquery.js?v=<%= DateTime.Now.ToString("ddMMyyyy")%>"></script>--%>
    ...
    <script>
        ...
        function addnewlink() {
            ...
            var _html = `<div  class="linkhrow-wrapper col-md-12 p-0"> <div class="row">
                            <div class="col-md-2 linkrow p-0" >
                                <button type="button" onclick="removelink(this)" class="btn btn-danger search-btn" style="height: 26px;width: 26px;padding: 3px;">
                                    <span class="material-icons">remove</span>
                                </button>
        ...
        function initLink() {
            ...
            //$('.attach-link').each(function (index , row) {
            //    $(row).trigger('change');
            //});
        }
