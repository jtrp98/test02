<%@ Page Title="" Language="C#" MasterPageFile="~/mppopup.Master" AutoEventWireup="true" CodeBehind="DepartmentList-edit.aspx.cs" Inherits="FingerprintPayment.department.DepartmentList_edit" %>
  ...
  margin-right: -30px;
    ...
    <div class="full-card text-center planeadd-container">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <h1 class="lefttext"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132076") %></h1>
                    <hr />
