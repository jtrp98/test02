        ...
        var i,
                ...
                ((f.prototype.init = function () {
                    ...
                    (f.prototype.refreshItemList = function () {
                        ...
                        0 < this.items.length
                            ...
                            : ((t = $("<li >")).append($("<a>").attr("href", "#!").html(this.noResultsText)).addClass("disabled"), l.push(t)),
                            this._dd.append(l);
                    }),
            ...
            h =
                ((c.prototype.getElPos = function () {
                    ...
                    (c.prototype.refreshItemList = function () {
                        ...
                        0 < this.items.length
                            ? (this.items.forEach(function (t) {
                                ...
                                var o = i.disabled,
                                    n = $("<a >");
                                n.addClass("dropdown-item").css({ overflow: "hidden", "text-overflow": "ellipsis" }).html(s).data("item", t), o && n.addClass("disabled"), l.push(n);
                            }),
                                this._dd.append(l),
                                this.show())
                            : "" === this.noResultsText
                                ? this.hide()
                                : ((t = $("<a >")).addClass("dropdown-item disabled").html(this.noResultsText), l.push(t), this._dd.append(l), this.show());
                    }),
                    ...
                    c),
            d =
                ((u.prototype.manageInlineDataAttributes = function () {
                    ...
                    (u.prototype.init = function () {
                        this.bindDefaultEventListeners(),
                            ...
                            4 === this.getBootstrapVersion()[0]
                                ? (this._dd = new h(this._$el, this._settings.formatResult, this._settings.autoSelect, this._settings.noResultsText))
