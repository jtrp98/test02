                ...
                { "mData": "InvoiceId", "sName": "SubLevelId", "aTargets": [12], "bVisible": false },
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        if (row.InvoiceStatus === invoiceApproveStatus) {
                            content += '<li><a target="_blank" style=\"font-size:20px;\" data-id="' + row.InvoiceId + '" data-code="' + row.InvoiceCode + '"  href="/Modules/Invoices/PrintInvoicePreview.aspx?InvoiceId=' + row.InvoiceId + '">ใบแจ้งหนี้</a></li>';
                        ...
                        if (row.OutstandingAmount != 0)
                            content += '<li><a data-id="' + row.InvoiceId + '" style=\"font-size:20px;\"  role="button" data-number="' + row.Code + '" target="_blank" href="/Modules/Invoices/Create.aspx?Mode=Edit&InvoiceId=' + row.InvoiceId + '">แก้ไข</a></li>';

                        content += '<li><a data-id="' + row.InvoiceId + '" style=\"font-size:20px;\" data-number="' + row.Code + '" target="_blank" href="/Modules/Invoices/Create.aspx?InvoiceId=' + row.InvoiceId + '">ข้อมูล</a></li>';
