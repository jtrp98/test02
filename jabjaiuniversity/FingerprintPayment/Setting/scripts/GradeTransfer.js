        ...
        //targets 1 to 5 hidden
        {
            ...
            render: function (data, type, row, meta) {
                ...
                if (row["IsSavedData"] == true) {
                    ...
                    return '<select class="selectpicker" data-style="select-with-transition" title="เลือกปี" onchange="YearOnChange(this,' + meta.row + ',' + $("#hdnNTSubLevel").val() + ',\'' + $("#hdnLevelName").val() + '\')" >' + opt + '</select >';
                }
                else
                {
                    return "";
        ...
        
        {
            ...
            render: function (data, type, row, meta) {
                ...
                if (row["IsSavedData"] == true) {
                    ...
                    return '<select  class="selectpicker" data-style="select-with-transition"  title="เลือกแผน"  onchange="PlanOnChange(this,' + meta.row + ')">' + opt + '</select >';
                }
                else {
                    return "";
                }
