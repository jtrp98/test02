<%@ Page Title="" Language="C#" MasterPageFile="~/Material3.Master" AutoEventWireup="true" CodeBehind="VisitHouseForm2.aspx.cs" Inherits="FingerprintPayment.VisitHousePage.Mobile.VisitHouseForm2" %>
...
และกด "บันทึก" เพื่อส่งข้อมูลอีกครั้ง`;
        ...
        function LoadHomeVisitData(schoolId, studentId) {
            $.ajax({
                type: "POST",
                url: "VisitHouseForm2.aspx/GetVisitHouseData",
        ...
        $(document).ready(function () {
            ...
            LoadHomeVisitData('<%=Request.QueryString["schoolid"]%>', '<%=Request.QueryString["sid"]%>');
