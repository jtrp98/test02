<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true"
    CodeBehind="useredit.aspx.cs" Inherits="FingerprintPayment.useredit" %>
        ...
        $(document).ready(function () {
            ...
            $("div[id*=TProduct_]").click(function (e, s) {
                ...
                if (_text.indexOf(this.id + ",") == -1 || _text == "") {
                    _html += "<span id=" + this.id + ">" + $(this).html() + "</span><img src='images/action_delete.png' style='vertical-align: middle;cursor:pointer;' name='" + this.id + "' onclick='DelSelectProduct(" + '"' + this.id + '"' + ")' /><br>";
                    _text += this.id + ",";
            ...
            jQuery.each(_str.split(','), function (index, item) {
                if (item != "") {
                    ...
                    _html += "<span id=" + _id + ">" + _val + "<img src='images/action_delete.png' style='vertical-align: middle;cursor:pointer;' name='" + _id + "' onclick='DelSelectProduct(" + '"' + _id + '"' + ")' /></span><br>";
                    $("div[id*=tdBlackList]").html(_html);
                }
            });
        });
            ...
            $.ajax({
                ...
                success: function (msg) {
                    $.each(msg, function (index) {
                        var _ch = "";
                        if ($('input[id*=txtSubLV2ID]').val() == msg[index].nTermSubLevel2) {
                            _ch = "selected";
                        }
                        if ($('input[id*=txtSubLV2ID]').val() == "") {
                            $('input[id*=txtSubLV2ID]').val(msg[index].nTermSubLevel2);
                        }
                        $('select[id*=ddlSubLV2]')
                            .append($("<option " + _ch + "></option>")
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-xs-5">
                <div class="input-group date-container">
                    <asp:TextBox ID="txtdBirth" runat="server" class="form-control datepicker" data-date-format="dd/mm/yyyy"
