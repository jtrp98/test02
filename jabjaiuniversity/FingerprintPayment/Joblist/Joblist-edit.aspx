<%@ Page Title="" Language="C#" MasterPageFile="~/mppopup.Master" AutoEventWireup="true" CodeBehind="Joblist-edit.aspx.cs" Inherits="FingerprintPayment.Joblist_edit" %>
  ...
  margin-right: -30px;
    ...
    <div class="full-card text-center planeadd-container">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <h1 class="leftText"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132307") %></h1>
                    <hr />
