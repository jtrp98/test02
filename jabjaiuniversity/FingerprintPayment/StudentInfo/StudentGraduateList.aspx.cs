...
{
    public partial class StudentGraduateList : StudentGateway
    {
        ...
        public static string LoadStudent()
        {
            ...
            var json = QueryEngine.LoadStudentGraduateJsonData(draw, pageIndex, pageSize, sortBy, GetUserData().CompanyID, year, term, level, className, stdName);
