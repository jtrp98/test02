<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true" CodeBehind="classmember-teacherlist.aspx.cs" Inherits="FingerprintPayment.classmember_teacherlist" %>
    ...
    <div class="full-card box-content">
        <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12 centertext">
                                                    <label ><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132059") %>
                                                        </label>
                    ...
                    <asp:GridView ID="dgd" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" ShowFooter="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-Width="50px" HeaderText="">
                                <ItemTemplate>                                    
                                   <a href="/classmember/classmember-add.aspx?id=<%# Eval("sEmp") %>&idlv=<%# Eval("idlv")%>&idlv2=<%# Eval("idlv2")%>&term=<%# Eval("term")%>&year=<%# Eval("year")%>" class=" btn  btn-info  "  
                                data-toggle="modal" data-target="#modalpopupdata"> <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M601019") %></a>                                                                     
                                </ItemTemplate>
