<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/mp_notFrom.Master" CodeBehind="ReportInvoice_02.aspx.cs" Inherits="FingerprintPayment.Modules.Reports.ReportInvoice_02" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link src="https://cdn.datatables.net/1.11.3/css/jquery.dataTables.min.css" type="text/css" />
    <link src="https://cdn.datatables.net/fixedcolumns/4.0.0/css/fixedColumns.dataTables.min.css" type="text/css" />
            ...
            <div id="chart" style="padding: 10px;">
                <form id="form-search">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-7">
                            <div class="col-md-3 text-right">
                                <label class="lb-control lable-text"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103166") %></label>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-1 text-right">
                                <label class="lb-control lable-text1"></label>
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xs-5">
                            <div class="col-md-3 text-right">
                                <label class="lb-control"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M603033") %></label>
                            </div>
                            <div class="col-md-6">
                                <select class="form-control select2" id="ddl-itemtype" name="PaymentGROUP">
                                    <option value="1"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M503010") %></option>
                                    <option value="2"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M503011") %></option>
                                </select>
                            </div>
                        </div>
                    </div>
    ...
    <script src="/Scripts/pages/report-invoice v2.js?v=<%=DateTime.Now.Ticks%>"></script>
    <script src="/Scripts/pages/report-invoice-excel v2.js?v=<%=DateTime.Now.Ticks%>"></script>
    ...
    <script>
        ...
        var exportExcelUrl = "<%=ResolveUrl("~/Handles/Reports/ReportInvoiceExcelHandler_02.ashx")%>";
