<%@ Page Title="" Language="C#" MasterPageFile="~/mppopup.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="planeedit.aspx.cs" Inherits="FingerprintPayment.Modules.TimeAttendance.planeedit" %>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <input class="form-control" type="text" clientidmode="Static"
                                id="txtPlaneID" runat="server" readonly="true" />
                        </div>
