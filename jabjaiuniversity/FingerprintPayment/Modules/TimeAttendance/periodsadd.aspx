<%@ Page Title="" Language="C#" MasterPageFile="~/mppopup.Master" AutoEventWireup="true"
    CodeBehind="periodsadd.aspx.cs" Inherits="FingerprintPayment.Modules.TimeAttendance.periodsadd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="full-card periodadd-container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <table class="periodsadd-table" style="padding-left: 10px; width: 100%">
                            <tr>
                                ...
                                <td>
                                    <input class="form-control subject-textfield" type="text" clientidmode="Static"
