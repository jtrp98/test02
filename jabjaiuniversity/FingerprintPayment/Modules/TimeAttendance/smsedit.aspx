<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true"
    CodeBehind="smsedit.aspx.cs" Inherits="FingerprintPayment.Modules.TimeAttendance.smsedit" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="detail-card box-content smsadd-container periodadd-container">
        ...
        <div class="row send_type_0">
            ...
            <div class="col-xs-8">
                <asp:DropDownList ID="ddlSendType" ClientIDMode="Static" runat="server" CssClass="form-control">
                    ...
                    <asp:ListItem Text="นักเรียนทังหมด" Value="1" />
            ...
            <div class="col-xs-12">
                <table id="tablelistuser" class="table table-striped col-lg-12 ">
                    <thead class="table-tab">
                        ...
                        <td style="width: 20%;"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102100") %></td>
                    </thead>
        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                <asp:TextBox ID="txtDesp" runat="server" MaxLength="512" TextMode="MultiLine" CssClass="form-control" Width="480px" Height="350px" style="resize: none !important;" />
            </div>
        </div>
            ...
            <ContentTemplate>
                <div class="row mini--space__top">
                    <div class="col-xs-12 center">
                        ...
                        &nbsp;<asp:Button ID="btnCancel" runat="server" Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101378") %>" class="btn btn-danger global-btn" />
                    </div>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
