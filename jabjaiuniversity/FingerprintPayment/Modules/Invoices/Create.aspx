<%@ Page Language="C#" MasterPageFile="~/mp_notFrom.Master" AutoEventWireup="true"
    CodeBehind="Create.aspx.cs" Inherits="FingerprintPayment.Modules.Invoices.Create" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="/Scripts/pages/invoice-detail.js?d=<%= DateTime.Now.ToString("yyyyMMddHHmmss") %>"></script>
    ...
    <script type="text/javascript">
        <%
        if (!string.IsNullOrEmpty(nTermID))
        {%>
        $(function () {
            $("#ddl-term").val('<%= nTermID %>')
        });
            <%}
        %>
    </script>
