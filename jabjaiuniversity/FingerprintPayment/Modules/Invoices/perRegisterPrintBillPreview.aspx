<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/mp_notFrom.Master"
    CodeBehind="perRegisterPrintBillPreview.aspx.cs" Inherits="FingerprintPayment.Modules.Invoices.perRegisterPrintBillPreview" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <page size="A4" id="page1">
        ...
        <div class="form-group" style="padding: 20px 0 0 15px">
            ...
            <div class="col-md-4">
             <%--   <p class="" style="font-size: 18px; margin: 0; padding: 0; height: 15px;"><b><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M107007") %>&nbsp;&nbsp;<span><%=Model.SubLevel+"/"+Model.SubLevel2 %></span></b></p>
        ...
        <div id="page2">
            ...
            <div class="form-group" style="padding: 0px 0 0 15px">
                ...
                <div class="col-md-4">
                    <p class="" style="font-size: 18px; margin: 0; height: 15px;"><b><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M107017") %>&nbsp;&nbsp;<span><%=Model.StudentCode %></span></b></p>
                    <p class="" style="font-size: 18px; margin: 0; height: 15px;"><b>Student Number</b></p>
                </div>
            </div>
            <div class="form-group" style="padding: 20px 0 0 15px">
