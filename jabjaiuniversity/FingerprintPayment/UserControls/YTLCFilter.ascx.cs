...
{
    public partial class YTLCFilter : System.Web.UI.UserControl
    {
        ...
        public bool IsLevelRequired { get; set; }
        public bool IsLevelMultiSelect { get; set; }
        ...
        private void InitialControl()
        {
            ...
            using (JabJaiEntities en = new JabJaiEntities(Connection.StringConnectionSchool(schoolID, ConnectionDB.Read)))
            {
                ...
                if ((IsRequired == false || IsLevelRequired == false) )
                {
                    this.ltrLevel.Text += string.Format(@"<option value="""" data-level="""">ทั้งหมด</option>");
                }
