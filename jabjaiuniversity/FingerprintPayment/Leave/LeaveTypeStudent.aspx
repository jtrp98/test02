<%@ Page Title="" Language="C#" MasterPageFile="~/Material2.Master" AutoEventWireup="true" CodeBehind="LeaveTypeStudent.aspx.cs" Inherits="FingerprintPayment.Leave.LeaveTypeStudent" %>
    ...
    <script>    
        ...
        function onSearch() {
            ...
            var dt = $('#lst-data').DataTable({
                ...
                ajax: {
                    url: "LeaveTypeStudent.aspx/GetData",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: 'json',
                    "dataSrc": function (r) {
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="text-muted" style="font-size: small;">
                <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M301038") %>
            </p>
        </div>
    </div>
