...
{
    public partial class LeaveType : Page
    {
        ...
        public static object GetData(Search search)
        {
            ...
            using (var db = new JabJaiEntities(Connection.StringConnectionSchool(userData.CompanyID,ConnectionDB.Read)))
            {
                var qry = db.TLeave_Type.Where(o => o.SchoolID == userData.CompanyID && o.IsDel == false && o.Type == "T")
                    .Select(o => new
                    {
                        o.TypeID,
                        o.TypeName,
                ...
                //var logs = db.TLeave_Log.Where(o => o.SchoolID == userData.CompanyID && o.Type == "3")
