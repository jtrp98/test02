<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="FingerprintPayment.StudentCall.Main" MasterPageFile="~/mpVoid.Master" %>
    ...
    <body>
        ...
        <script>
            ...
            function refreshConn() {
                ...
                $.ajax({
                    type: "GET",
                    url: "Main.aspx/RefreshConnection",
                    /*data: "{}",*/
