<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="preRegisterAddUser.aspx.cs" Inherits="FingerprintPayment.PreRegister.preRegisterAddUser" %>
                            ...
                            <div class="contentBox">
                                        ...
                                        <asp:PostBackTrigger ControlID="Button1" />
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 pad0 control-label righttext">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103080") %><br><sub><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103081") %></sub></label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
