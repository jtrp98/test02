<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/grade/iframe.Master" CodeBehind="registerUser.aspx.cs" Inherits="FingerprintPayment.PreRegister.registerUser" EnableEventValidation="false" %>
...
function Radio_Click12() {
   ...
   <div id="loading" class="loading hidden"></div>
    ...
    <div class="full-card planelist-container" style="overflow-x: hidden;">
                ...
                <div class="wizard-inner">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103046") %>">
                        ...
                        <li role="presentation" class="disabled">
                            <a href="#step2" data-toggle="tab" aria-controls="step2" role="tab" title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132969") %>">
                                <span class="round-tab">
                                    <i class="hid">1</i>
                            ...
                            <div class="contentBox">
                                <div class="column70">
                                    ...
                                    <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 pad0 control-label righttext">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101018") %> <br/><sub><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132770") %></sub></label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 pad0 control-label righttext">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101019") %> <br/><sub><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132770") %></sub></label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 pad0 control-label righttext">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M104024") %> <br/><sub><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103053") %></sub></label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 pad0 control-label righttext">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M104024") %> <br/><sub><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103054") %></sub></label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:TextBox ID="citizenID" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:TextBox ID="sPhone" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student">
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:TextBox ID="stdHomenum2" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student">
                                        ...
                                        <asp:PostBackTrigger ControlID="Button1" />
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:TextBox ID="TextBox50" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:DropDownList ID="DropDownList8" runat="server" CssClass="width100 form-control titlecheck">                                                                                                                        
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 pad0 control-label righttext">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101109") %><br/><sub style=""><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103074") %></sub></label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:TextBox ID="TextBox6" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>                                            
                                     ...
                                     <div class="form-group row student">
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:Textbox ID="friendPhone" onkeypress="return isNumber(event)" runat="server" class="form-control inputname"  width="100%" ></asp:Textbox> 
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-3 pad0 control-label righttext">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101109") %></label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:TextBox ID="TextBox21" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student">
...
<ul id="geoData">
    ...
    <div id="lon" class="hidden"></div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2" style="border-top: 0; padding-top: 0; margin-top: 0;">
                        <div class="step2">
                            <h1><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132969") %></h1>
                        </div>
                        <div class="">
                                <div class="">
                                    <div class="col-xs-12">                                                
                                  ...
                                  <Triggers>
                                    ...
                                    <div class="form-group row student">
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <div class="col-xs-5 control-input">
                                                <asp:DropDownList ID="oldSchoolGraduated" runat="server" CssClass="width100 form-control oGradu pagegradu">
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pad0 control-label righttext">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101075") %></label>
                                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-input pad0" style="">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 control-input pad0" style="">
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext" style="overflow: hidden; white-space: nowrap; font-size:90%">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101076") %></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="famIdCard" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:TextBox ID="TextBox28" onkeypress="return isNumber(event)" runat="server" CssClass='form-control famPost' class="input--mid"></asp:TextBox>
                                                    </div>
                                            ...
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="famPhone1" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="famPhone2" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="famPhone3" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row student">
                                                <div class="col-md-12 col-sm-12">
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext" style="overflow: hidden; white-space: nowrap; font-size:90%">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101076") %></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="fatherIdCard" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student">
                                            ...
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext">
                                                       <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M104044") %></label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:TextBox ID="TextBox33" onkeypress="return isNumber(event)" runat="server" CssClass='form-control famPost' class="input--mid"></asp:TextBox>
                                                    </div>
                                                    <label class="col-lg-1 col-md-1 col-sm-1 col-xs-1 control-label righttext">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102110") %></label>
                                                </div>
                                            ...
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext" style="">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101109") %><br/><sub>(<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M131216") %>)</sub></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="TextBox34" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext" style="">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101109") %><br/><sub>(<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M701042") %>)</sub></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="TextBox35" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext" style="">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101109") %><br/><sub>(<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M131217") %>)</sub></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="TextBox37" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext" style="overflow: hidden; white-space: nowrap; font-size:90%">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101076") %></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="motherIdCard" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student" >
                                            ...
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext">
                                                       <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M104044") %></label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                        <asp:TextBox ID="TextBox40" onkeypress="return isNumber(event)" runat="server" CssClass='form-control famPost' class="input--mid"></asp:TextBox>
                                                    </div>
                                                    <label class="col-lg-1 col-md-1 col-sm-1 col-xs-1 control-label righttext">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102110") %></label>
                                                </div>
                                            ...
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext" style="">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101109") %><br/><sub>(<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M131216") %>)</sub></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="TextBox45" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext" style="">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101109") %><br/><sub>(<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M701042") %>)</sub></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="TextBox46" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row student" >
                                                <div class="col-md-12 col-sm-12" >
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label righttext" style="">
                                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101109") %><br/><sub>(<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M131217") %>)</sub></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 control-input">
                                                        <asp:TextBox ID="TextBox47" onkeypress="return isNumber(event)" runat="server" CssClass='form-control' class="input--mid"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-input">
                                                <asp:DropDownList ID="ddlBlood" runat="server" CssClass="width100 form-control">
                                                    <asp:ListItem Enabled="true" Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101218") %>" Value=""></asp:ListItem>
                                                            <asp:ListItem E Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103117") %>" Value="O"></asp:ListItem>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="col-xs-5 control-input">
                                    <ul class="list-inline ">
                                        ...
                                        <li onclick="loading()">
                                            <asp:Button ID="Button1" class="btn btn-success global-btn" runat="server" Text="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M401024") %>" ValidationGroup="add" />
                                        </li>
