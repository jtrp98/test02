<%@ Page Title="" Language="C#" MasterPageFile="~/PreRegister/RegisterOnline.Master" AutoEventWireup="true" CodeBehind="RegisterQualifyResult.aspx.cs" Inherits="FingerprintPayment.PreRegister.RegisterQualifyResult" %>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 text-center" style="padding-top: 25px;">
                            <span style="margin-top: 28px; font-size: 1.7em; color: #000; font-weight: bold;"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132947") %> <%=registerYearBE %></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 text-center" style="padding-top: 25px;">
                            <button id="btnResultCheck" class="btn btn-lg col-md-3" style="background-color: #f5f5f5; border: 1px solid #606060; color: #000; padding: 5px 10px; border-radius: 7px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 text-left print-form" style="padding: 10px 10px 0px 20px;">
                                        <h5><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132948") %></h5>
                                        <h6></h6>
                                    </div>
                                </div>
                            </button>
        ...
        $(document).ready(function () {
            ...
            $("#btnResultCheck").bind({
                click: function () {
                    ...
                    window.location.href = "RegisterQualifyResultCheck.aspx";
