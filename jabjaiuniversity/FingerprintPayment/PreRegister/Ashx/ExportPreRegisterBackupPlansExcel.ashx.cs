...
{
    /// <summary>
    /// Summary description for ExportPreRegisterBackupPlansExcel
    /// </summary>
    public class ExportPreRegisterBackupPlansExcel : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            ExcelPackage excel = ReportEngine.ExportReportPreRegisterBackupPlansExcel(col, dir, userData.CompanyID, year, regStatus, optLevel, couType, couTime, branch, stdName, plan);
