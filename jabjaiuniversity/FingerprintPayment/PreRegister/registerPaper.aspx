<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="registerPaper.aspx.cs" Inherits="FingerprintPayment.PreRegister.registerPaper" %>
...
<body>
    <form id="form1" runat="server">
        <button class="btn btn-default display-student-id no-print-me" type="button" data-color="primary" data-show-student-id="1">
            <i class="state-icon glyphicon glyphicon-check"></i>&nbsp;<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103226") %>
        </button>
        ...
        <div>
            <div class="w3-button w3-teal w3-xlarge w3-right no-print hideop" style="position: fixed; top: 20%; right: 10px; z-index: 4; border: 1px solid black; font-family: THSarabun; width: 84px;" onclick="w3_open()"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M303007") %></div>
        </div>
            ...
            <div class="page printableArea pagecut" style="padding: 0px;">
                <div class="subpage">
                    ...
                    <div class="col-xs-2" style="padding: 0px; font-family: THSarabun;">
                        ...
                        <div class="col-xs-10 pad0">
                            <div class="col-xs-8" style="height: 3cm; width: 2.5cm; border: 2px; border-color: black; border-style: solid; line-height: 3cm; text-align: center; <%=HaveProfileImage?"display: none;":""%>">
                                <label><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M105026") %></label>
                            </div>
                            <img src="<%=ProfileImageUrl%>" style="height: 3cm; width: 2.5cm; border: 2px; border-color: black; border-style: solid; padding: 1px; <%=HaveProfileImage?"":"display: none;"%>" />
                        </div>
                    </div>
                    <div class="col-xs-12" style="padding: 0px;">
                    </div>
                ...
                <div class="subpage">
                    <div class="col-xs-12 pad0">
                        <div class="col-xs-2" style="padding-top: 10px;">
                            <img id="Img3" runat="server" alt="" class="avatar img-responsive centertext" style="margin: 0 auto; display: block; /* width: 90px; */ height: 100px; max-width: none;" />
                        </div>
                        <div class="col-xs-8" style="padding: 12px 17px 0px 17px; width: 465px;">
                            ...
                            <div class="col-xs-6" style="padding-right: 10px; margin-top: 5px;">
                            ...
                            <div class="col-xs-6" style="padding-left: 10px; margin-top: 5px; display: flex;">
                        ...
                        <div class="col-xs-2 pad0" style="width: 150px; padding-left: 55px;">
                            <p style="position: absolute; width: 210px; margin-left: -105px; font-size: 17px;"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132034") %> : _________________</p><p class="student-id" style="position: absolute; font-size: 19px; width: 100px; text-align: center; margin-top: -3px;"><%=ltrStudentID.Text %></p>
                            <div class="col-xs-10 pad0" style="margin-top: 21px; margin-left: 8px;">
                                <div class="col-xs-8" style="height: 2.7cm; width: 2.3cm; border: 1px; border-color: #ccc; border-style: dashed; line-height: 2.5cm; text-align: center; font-size: 1.3em; color: #999; <%=HaveProfileImage?"display: none;":""%>">
                                ...
                                <img src="<%=ProfileImageUrl%>" style="height: 2.7cm; width: 2.3cm; border: 1px; border-color: #ccc; border-style: dashed; padding: 1px; <%=HaveProfileImage?"":"display: none;"%>" />
                            </div>
                        </div>
                        <div class="col-xs-12 lefttext" style="margin-bottom: 5px;">
                            <hr class="margin10" />
                        ...
                        <div class="col-xs-6 h25 pad30" style="<%=(mode == "1" ? "margin-top: 80px;" : "margin-top: 14px;") %> padding-left: 90px;">
                            <div class="col-xs-1 pad0 lh50 leftim" style="width: 30px;">
                        ...
                        <div class="col-xs-6 h25 pad30" style="<%=(mode == "1" ? "margin-top: 80px;" : "margin-top: 14px;") %> padding-left: 45px;">
                            <div class="col-xs-1 pad0 lh50 leftim" style="width: 30px;">
                        ...
                        <div class="col-xs-6 h25 pad30 <%= (mode == "1" ? "" : "hidden") %>" style="padding-left: 94px;">
                            <div class="col-xs-1 pad0 lh50" style="width: 25px;">
                        ...
                        <div class="col-xs-6 h25 pad30 <%= (mode == "1" ? "" : "hidden") %>" style="padding-left: 45px;">
                            <div class="col-xs-1 pad0 lh50" style="width: 25px;">
                    ...
                    <div class="col-xs-12 padding-0">
                        <div class="col-xs-5 padding-0">
                            <div class="col-xs-12 border">
                                ...
                                <p><i class="far fa-circle"></i><span><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132873") %> <%--200--%><asp:Literal ID="ltrFee" runat="server"></asp:Literal> <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102110") %></span></p>
                            </div>
                        ...
                        <div class="col-xs-7 padding-0">
                            <div class="col-xs-12 padding-0">
                                <div class="col-xs-7 text-center">
                                    <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" id="imgPage8Logo" runat="server" class="" style="/* width: 90px; */ height: 113px; margin-top: 12px;" />
                                </div>
                                <div class="col-xs-5 padding-0 text-right">
                                    <div class="input-row underline" style="width: 183px; display: none;"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132899") %>&nbsp;<span><%--2564--%><asp:Literal ID="ltrRegisterYear" runat="server"></asp:Literal></span></div>
                                    <p>&nbsp;</p>
                                    <div class="font20 input-row">
                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M107017") %><div class="input-value" style="width: 109px;"><span><%--0000000--%><asp:Literal ID="ltrStudentID" runat="server"></asp:Literal></span></div>
                                    </div>
                                    <div class="font20 input-row">
                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132900") %><div class="input-value" style="width: 77px;"><span class="font18"><%--0000000--%><asp:Literal ID="ltrExamCode" runat="server"></asp:Literal></span></div>
                                    </div>
                                    <div class="font20 input-row">
                                        <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132901") %><div class="input-value" style="width: 119px;"><span><%--0000000--%><asp:Literal ID="ltrRegisterLevel" runat="server"></asp:Literal></span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 padding-0">
                                <div class="col-xs-7 text-center">
                                    <p class="font25 bold"><asp:Literal ID="ltrReport5Topic" runat="server"></asp:Literal><%--<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132903") %>--%></p>
                                    <p class="font25 bold">
                                ...
                                <div class="col-xs-5 padding-0 text-right">
                                    <div class="col-xs-8 padding-0" style="height: 3.1cm; width: 2.8cm; border: 1px; border-color: #ccc; border-style: dashed; line-height: 2.5cm; text-align: center; font-size: 1.3em; color: #999; float: right; <%=HaveProfileImage?"display: none;":""%>">
                                    ...
                                    <img src="<%=ProfileImageUrl%>" style="height: 3.1cm; width: 2.8cm; border: 1px; border-color: #ccc; border-style: dashed; padding: 1px; float: right; <%=HaveProfileImage?"":"display: none;"%>" />
                                </div>
                            </div>
                            <div class="col-xs-12 padding-0">
                        ...
                        <div class="col-xs-12 padding-lr-10 padding-t-10">
                            <div class="col-xs-12 input-row">
                                <div class="font22 input-row">
                                    <b><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M107018") %> <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101002") %></b><div class="input-value" style="width: 209px;"><span><%--0000000--%><asp:Literal ID="ltrStudentName" runat="server"></asp:Literal></span></div>
                                </div>
                                <div class="font22 input-row">
                                    <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M104024") %><div class="input-value" style="width: 80px;"><span><%--0000000--%><asp:Literal ID="ltrStudentNickname" runat="server"></asp:Literal></span></div>
                                </div>
                                <div class="font22 input-row">
                                    <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M106111") %><div class="input-value" style="width: 130px;"><span><!--0000000--><asp:Literal ID="ltrIdentification" runat="server"></asp:Literal></span></div>
                                </div>
                            </div>
                            <div class="col-xs-12 input-row">
                                <div class="font22 input-row">
                                ...
                                <div class="font22 input-row">
                                    <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M107038") %> <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132908") %><div class="input-value" style="width: 160px; position: relative;"><span class="textfit" data-textfit-min="12" data-textfit-max="21" data-textfit-adjust="0.91" style="display: inline-block; width: 180px; white-space: pre-wrap; line-height: 0.7; font-size: 21px; position: absolute; bottom: 0; left: 0;"><%--0000000--%><asp:Literal ID="ltrSymptoms" runat="server"></asp:Literal></span></div>
                                </div>
                            </div>
                            <div class="col-xs-12 input-row">
                                <div class="font22 input-row">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.display-student-id').bind({
                click: function () {

                    if ($(this).data('show-student-id') == 0) {
                        $(this).removeClass('btn btn-default').addClass('btn btn-primary active');
                        $(this).find('i').removeClass('glyphicon-unchecked').addClass('glyphicon-check');

                        $(this).data('show-student-id', 1);

                        // Show o-net score
                        $('.student-id').show();
                    }
                    else {
                        $(this).removeClass('btn btn-primary active').addClass('btn btn-default');
                        $(this).find('i').removeClass('glyphicon-check').addClass('glyphicon-unchecked');

                        $(this).data('show-student-id', 0);
