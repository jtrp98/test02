...
{
    public partial class registerPaperHistory : PreRegisterGateway
    {
        static class Rot13
        {
            /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(enSourceId))
            {
                ...
                using (JabJaiEntities _db = new JabJaiEntities(Connection.StringConnectionSchool(schoolID,ConnectionDB.Read)))
                {
                    ...
                    fatherPhone2.Text = fatherPhoneNumber;
                    ...
                    motherPhone2.Text = motherPhoneNumber;
                    ...
                    famPhone2.Text = familyPhoneNumber;
                    ...
                    Label13.Text = "รายงานประวัติข้อมูลนักเรียน";
                    ...
                    if (user.sIdentification != "" && user.sIdentification != null)
                    {
                        ...
                        {
                            page7line1_4txta1.Text = page6line1_4txta1.Text = user.sIdentification[0].ToString();
                            page7line1_4txta2.Text = page6line1_4txta2.Text = user.sIdentification[1].ToString();
                            page7line1_4txta3.Text = page6line1_4txta3.Text = user.sIdentification[2].ToString();
                            page7line1_4txta4.Text = page6line1_4txta4.Text = user.sIdentification[3].ToString();
                            page7line1_4txta5.Text = page6line1_4txta5.Text = user.sIdentification[4].ToString();
                            page7line1_4txta6.Text = page6line1_4txta6.Text = user.sIdentification[5].ToString();
                            page7line1_4txta7.Text = page6line1_4txta7.Text = user.sIdentification[6].ToString();
                            page7line1_4txta8.Text = page6line1_4txta8.Text = user.sIdentification[7].ToString();
                            page7line1_4txta9.Text = page6line1_4txta9.Text = user.sIdentification[8].ToString();
                            page7line1_4txta10.Text = page6line1_4txta10.Text = user.sIdentification[9].ToString();
                            page7line1_4txta11.Text = page6line1_4txta11.Text = user.sIdentification[10].ToString();
                            page7line1_4txta12.Text = page6line1_4txta12.Text = user.sIdentification[11].ToString();
                            page7line1_4txta13.Text = page6line1_4txta13.Text = user.sIdentification[12].ToString();
                        }
                    }
                    ...
                    if (user.sStudentHomeRegisterCode != null && user.sStudentHomeRegisterCode != "")
                    {
                        ...
                        {
                            page7line1_4txtb1.Text = page6line1_4txtb1.Text = user.sStudentHomeRegisterCode[0].ToString();
                            page7line1_4txtb2.Text = page6line1_4txtb2.Text = user.sStudentHomeRegisterCode[1].ToString();
                            page7line1_4txtb3.Text = page6line1_4txtb3.Text = user.sStudentHomeRegisterCode[2].ToString();
                            page7line1_4txtb4.Text = page6line1_4txtb4.Text = user.sStudentHomeRegisterCode[3].ToString();
                            page7line1_4txtb5.Text = page6line1_4txtb5.Text = user.sStudentHomeRegisterCode[4].ToString();
                            page7line1_4txtb6.Text = page6line1_4txtb6.Text = user.sStudentHomeRegisterCode[5].ToString();
                            page7line1_4txtb7.Text = page6line1_4txtb7.Text = user.sStudentHomeRegisterCode[6].ToString();
                            page7line1_4txtb8.Text = page6line1_4txtb8.Text = user.sStudentHomeRegisterCode[7].ToString();
                            page7line1_4txtb9.Text = page6line1_4txtb9.Text = user.sStudentHomeRegisterCode[8].ToString();
                            page7line1_4txtb10.Text = page6line1_4txtb10.Text = user.sStudentHomeRegisterCode[9].ToString();
                            page7line1_4txtb11.Text = page6line1_4txtb11.Text = user.sStudentHomeRegisterCode[10].ToString();
                        }
                    }
                    ...
                    if (user.sFatherIdCardNumber != "" && user.sFatherIdCardNumber != null)
                    {
                        if (user.sFatherIdCardNumber.Length == 13)
                        {
                            page7line4_4_1.Text = page6line4_4_1.Text = user.sFatherIdCardNumber[0].ToString();
                            page7line4_4_2.Text = page6line4_4_2.Text = user.sFatherIdCardNumber[1].ToString();
                            page7line4_4_3.Text = page6line4_4_3.Text = user.sFatherIdCardNumber[2].ToString();
                            page7line4_4_4.Text = page6line4_4_4.Text = user.sFatherIdCardNumber[3].ToString();
                            page7line4_4_5.Text = page6line4_4_5.Text = user.sFatherIdCardNumber[4].ToString();
                            page7line4_4_6.Text = page6line4_4_6.Text = user.sFatherIdCardNumber[5].ToString();
                            page7line4_4_7.Text = page6line4_4_7.Text = user.sFatherIdCardNumber[6].ToString();
                            page7line4_4_8.Text = page6line4_4_8.Text = user.sFatherIdCardNumber[7].ToString();
                            page7line4_4_9.Text = page6line4_4_9.Text = user.sFatherIdCardNumber[8].ToString();
                            page7line4_4_10.Text = page6line4_4_10.Text = user.sFatherIdCardNumber[9].ToString();
                            page7line4_4_11.Text = page6line4_4_11.Text = user.sFatherIdCardNumber[10].ToString();
                            page7line4_4_12.Text = page6line4_4_12.Text = user.sFatherIdCardNumber[11].ToString();
                            page7line4_4_13.Text = page6line4_4_13.Text = user.sFatherIdCardNumber[12].ToString();
                        }
                    }

                    if (user.sMotherIdCardNumber != "" && user.sMotherIdCardNumber != null)
                    {
                        if (user.sMotherIdCardNumber.Length == 13)
                        {
                            page7line4_9_1.Text = page6line4_9_1.Text = user.sMotherIdCardNumber[0].ToString();
                            page7line4_9_2.Text = page6line4_9_2.Text = user.sMotherIdCardNumber[1].ToString();
                            page7line4_9_3.Text = page6line4_9_3.Text = user.sMotherIdCardNumber[2].ToString();
                            page7line4_9_4.Text = page6line4_9_4.Text = user.sMotherIdCardNumber[3].ToString();
                            page7line4_9_5.Text = page6line4_9_5.Text = user.sMotherIdCardNumber[4].ToString();
                            page7line4_9_6.Text = page6line4_9_6.Text = user.sMotherIdCardNumber[5].ToString();
                            page7line4_9_7.Text = page6line4_9_7.Text = user.sMotherIdCardNumber[6].ToString();
                            page7line4_9_8.Text = page6line4_9_8.Text = user.sMotherIdCardNumber[7].ToString();
                            page7line4_9_9.Text = page6line4_9_9.Text = user.sMotherIdCardNumber[8].ToString();
                            page7line4_9_10.Text = page6line4_9_10.Text = user.sMotherIdCardNumber[9].ToString();
                            page7line4_9_11.Text = page6line4_9_11.Text = user.sMotherIdCardNumber[10].ToString();
                            page7line4_9_12.Text = page6line4_9_12.Text = user.sMotherIdCardNumber[11].ToString();
                            page7line4_9_13.Text = page6line4_9_13.Text = user.sMotherIdCardNumber[12].ToString();
                        }
                    }

                    if (user.sFamilyIdCardNumber != "" && user.sFamilyIdCardNumber != null)
                    {
                        if (user.sFamilyIdCardNumber.Length == 13)
                        {
                            page7line6_4_1.Text = page6line6_4_1.Text = user.sFamilyIdCardNumber[0].ToString();
                            page7line6_4_2.Text = page6line6_4_2.Text = user.sFamilyIdCardNumber[1].ToString();
                            page7line6_4_3.Text = page6line6_4_3.Text = user.sFamilyIdCardNumber[2].ToString();
                            page7line6_4_4.Text = page6line6_4_4.Text = user.sFamilyIdCardNumber[3].ToString();
                            page7line6_4_5.Text = page6line6_4_5.Text = user.sFamilyIdCardNumber[4].ToString();
                            page7line6_4_6.Text = page6line6_4_6.Text = user.sFamilyIdCardNumber[5].ToString();
                            page7line6_4_7.Text = page6line6_4_7.Text = user.sFamilyIdCardNumber[6].ToString();
                            page7line6_4_8.Text = page6line6_4_8.Text = user.sFamilyIdCardNumber[7].ToString();
                            page7line6_4_9.Text = page6line6_4_9.Text = user.sFamilyIdCardNumber[8].ToString();
                            page7line6_4_10.Text = page6line6_4_10.Text = user.sFamilyIdCardNumber[9].ToString();
                            page7line6_4_11.Text = page6line6_4_11.Text = user.sFamilyIdCardNumber[10].ToString();
                            page7line6_4_12.Text = page6line6_4_12.Text = user.sFamilyIdCardNumber[11].ToString();
                            page7line6_4_13.Text = page6line6_4_13.Text = user.sFamilyIdCardNumber[12].ToString();
                        }
                    }
            ...
            string educate(int? index)
            {
                string txt = "";
                if (index == 1)
                    txt = "ต่ำกว่าประถมศึกษา";
                else if (index == 2)
                    txt = "ประถมศึกษา";
                else if (index == 3)
                    txt = "มัธยมศึกษาหรือเทียบเท่า";
                else if (index == 4)
                    txt = "ปริญญาตรี หรือเทียบเท่า ";
                else if (index == 5)
                    txt = "ปริญญาโท";
                else if (index == 6)
                    txt = "สูงกว่าปริญญาโท";
