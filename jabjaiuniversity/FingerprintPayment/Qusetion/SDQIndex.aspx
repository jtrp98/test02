<%@ Page Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true" CodeBehind="SDQIndex.aspx.cs" Inherits="FingerprintPayment.Qusetion.SDQIndex" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <asp:GridView ID="dgd" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" ShowFooter="False" GridLines="None" AllowPaging="True" Font-Bold="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderStyle-Width="20%" DataField="studentId" HeaderText="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M104022") %>">
                                <HeaderStyle Width="10%" CssClass="centerText"></HeaderStyle>
                            </asp:BoundField>
                            ...
                            <asp:BoundField HeaderStyle-Width="200px" ItemStyle-CssClass="havedata hidden" DataField="haveData" HeaderText="test">
                                <HeaderStyle Width="0.1%" CssClass="centerText hidden"></HeaderStyle>
                            </asp:BoundField>

                            <asp:TemplateField>
                                <ItemTemplate>
                                    <a class="btn btn-primary button1 hidden" id="squestion" href="SdqQuestion.aspx?id=<%# Eval("sID") %>" data-toggle="tooltip" title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M133012") %>" style="width: 150px"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M133013") %></a>

                                    <a class="btn btn-danger button2 hidden" id="report" href="SDQ_Report.aspx?id=<%# Eval("sID") %>" data-toggle="tooltip" title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M133014") %>" style="width: 150px"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M133014") %></a>
                                </ItemTemplate>
                                <HeaderTemplate>
                                    <center>  
    ...
    <script type="text/javascript">   
        ...
        //    for (var x = 0; x < havedata.length; x++) {

        //        if (havedata[x].textContent == "0") {
        //            button1[x].classList.remove('hidden');
        //        } else {
        //            button2[x].classList.remove('hidden');
        //        }
        //    }
        //}
