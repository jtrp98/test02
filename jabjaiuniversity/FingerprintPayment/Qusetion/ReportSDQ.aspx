<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true" CodeBehind="ReportSDQ.aspx.cs" Inherits="FingerprintPayment.Qusetion.ReportSDQ" %>
            ...
            <table id="tableData" class="table table-bordered table-hover" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th style="width: 12%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101018") %></th>
                        <th style="width: 12%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M101019") %></th>
                        <th style="width: 9%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103187") %></th>
                        <th style="width: 7%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M02323") %></th>
                        <th style="width: 7%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M00282") %></th>
                        <th style="width: 7%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M02108") %></th>
                        <th style="width: 10%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M00295") %></th>
                        <th style="width: 8%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M02147") %></th>
                        <th style="width: 7%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M133118") %></th>
                        <th style="width: 7%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M01121") %></th>
                    </tr>
                </thead>
        ...
        var studentList = {
            ...
            LoadListData: function () {
                studentList.dt = $(".studentList #tableData").DataTable({
                    ...
                    "stateSave": true,
                    "ajax": {
                        "url": "ReportSDQ.aspx/LoadReportSDQ",
                        "type": "POST",
                    ...
                    "columns": [
                        ...
                        { "data": "SDQ1T", "orderable": true },
                        { "data": "SDQ2T", "orderable": true },
                        { "data": "SDQ3T", "orderable": true },
                        { "data": "SDQ4T", "orderable": true },
                        { "data": "SDQ5T", "orderable": true },
                        { "data": "SDQ14T", "orderable": true },
                        { "data": "SDQRT", "orderable": true }
                    ],
                    "order": [[1, "asc"]],
                    "columnDefs": [
        ...
        function LoadTermSubLevel2(subLevelID, objResult) {
            if (subLevelID) {
                $.ajax({
                    async: false,
                    type: "POST",
                    url: "ReportSDQ.aspx/LoadTermSubLevel2",
        ...
        $(document).ready(function () {
            ...
            $(".studentList #iptStudentName").autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        url: "ReportSDQ.aspx/GetStudentName",
