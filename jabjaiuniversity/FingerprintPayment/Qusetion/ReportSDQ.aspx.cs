...
{
    public partial class ReportSDQ : StudentGateway
    {
        ...
        public static string LoadReportSDQ()
        {
            var jsonStream = "";
            ...
            switch (sortIndex)
            {
                ...
                case "5": sortBy = "SDQ1"; break;
                case "6": sortBy = "SDQ2"; break;
                case "7": sortBy = "SDQ3"; break;
                case "8": sortBy = "SDQ4"; break;
                case "9": sortBy = "SDQ5"; break;
                case "10": sortBy = "SDQ6"; break;
                case "11": sortBy = "SDQR"; break;
            }
            ...
            var json = QueryEngine.LoadReportSDQJsonData(draw, pageIndex, pageSize, sortBy, GetUserData().CompanyID, year, term, level, className, stdName);
