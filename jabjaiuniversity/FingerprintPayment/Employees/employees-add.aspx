<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master"
    AutoEventWireup="true" CodeBehind="employees-add.aspx.cs"
    Inherits="FingerprintPayment.Employees.employees_add" %>
        ...
        $(function () {
            $("form").submit(function (e) {
                if ($("input[id*=empPhone]").val() === "") {
                    e.preventDefault()
                    $("#modalpopupdata-content").html("<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M121035") %>");
                                            ...
                                            <div class="column70">
                                                ...
                                                <div class="form-group row student">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                            <asp:TextBox ID="empName" runat="server" CssClass='form-control' class="input--mid" MaxLength="250"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row student">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                            <asp:TextBox ID="empLastname" runat="server" CssClass='form-control' class="input--mid" MaxLength="250"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row student">
                                                    <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-input">
                                                            <asp:TextBox ID="empIdCard" runat="server" CssClass='form-control' class="input--mid" MaxLength="13"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row student">
        ...
        <div class="modal-dialog maclist-modal" style="top: 50px;">
            <div class="modal-content">
                <div class="modal-header">
                    <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString('M03000') %>
                </div>
