<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferData.aspx.cs" Inherits="FingerprintPayment.AssetManagement.TransferData" %>
...
<body>
    <asp:MultiView ID="MvContent" runat="server">
            ...
            <div class="transferList">
                <div class="row">
                    <div class="col-md-4 mb-4 text-left" style="padding-left: 1%;">
                        <span><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132024") %></span>
                    </div>
                ...
                <table id="tableData" class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 20%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132026") %></th>
                            <th style="width: 20%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132025") %></th>
                            <th style="width: 10%" class="text-center">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalShowForm" form-name="TransferData.aspx" form-action="form" form-title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132027") %>"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M601032") %></button></th>
                            <th></th>
                            <th></th>
                        </tr>
                    </thead>
            ...
            <script type="text/javascript">
                ...
                var transferList = {
                    ...
                    LoadListData: function () {
                        var dt = $(".transferList #tableData").DataTable({
                            "processing": true,
                            "serverSide": true,
                            "info": false,
                            "searching": false,
                            ...
                            "stateSave": true,
                            "ajax": {
                                "url": "Ashx/LoadTransferList.ashx",
                                "type": "POST",
                                "contentType": "application/json; charset=utf-8",
                                "data": function (d) { 
                                    d.searchDate = '';
                                    d.page = transferList.PageIndex;
                                    d.length = transferList.PageSize;
                            ...
                            "columns": [
                                ...
                                { "data": "DepRequest", "orderable": true },
                                { "data": "DepTransfer", "orderable": true },
                                ...
                                { "targets": [9, 10], "visible": false },
                                {
                                    "render": function (data, type, row) {
                                        return '<div class="btn-group">' +
                                                    //'<a href="#" data-toggle="modal" data-target="#modalShowForm" form-name="TransferData.aspx" form-action="view" form-title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132027") %>"><i class="fa fa-user"></i></a>' +
                                                    '<a href="#" data-toggle="modal" data-target="#modalShowForm" form-name="TransferData.aspx" form-action="form" form-title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132027") %>"><i class="fa fa-edit"></i></a>' +
                            ...
                            "drawCallback": function (settings) { 
                                ...
                                transferList.PageCount = json.pageCount;

                                var options = '';
                                for (var pi = 0; pi < json.pageCount; pi++) {
                                    options += '<option ' + (transferList.PageIndex == pi ? 'selected="selected"' : '') + ' value="' + pi + '">' + (pi + 1) + '</option>';
                                }
                                $('.transferList #tableData #sltPageIndex').html(options);

                                $('.transferList #tableData #spnPageInfo').html('<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102240") %> ' + (transferList.PageIndex + 1) + ' <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102241") %> ' + transferList.PageSize + ' <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M801009") %>');
                            }
                        });
                        // order.dt search.dt
                        dt.on('draw.dt', function () {
                            dt.column(0, { search: 'applied', order: 'applied' }).nodes().each(function (cell, i) {
                                cell.innerHTML = (transferList.PageIndex * transferList.PageSize) + (i + 1) + '.';
                            });
                            dt.column(8, { search: 'applied', order: 'applied' }).nodes().each(function (cell, i) {
                                var year = dt.cells({ row: i, column: 9 }).data()[0];
                                var id = dt.cells({ row: i, column: 10 }).data()[0];
                    ...
                    RemoveItem: function (year, id) {
                        $.ajax({
                            type: "POST",
                            url: "TransferData.aspx/RemoveItem",
                            data: '{year: ' + year + ', id: ' + id + '}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: transferList.OnSuccessRemove,
                ...
                $(document).ready(function () {
                    ...
                    $('#modalNotifyConfirmRemove').find('.modal-footer #modalConfirmRemove').on('click', function () {
                        ...
                        // Remove command
                        transferList.RemoveItem($(this).attr('year'), $(this).attr('id'));

                    });

                    // Searching, Pagination event 
                    $('.transferList #btnSearch').click(function () {

                        transferList.PageIndex = 0;
                    ...
                    $('.transferList #tableData #sltPageSize').change(function () {

                        transferList.PageSize = parseInt($(".transferList #tableData #sltPageSize").children("option:selected").val());
                        transferList.PageIndex = 0;
                    ...
                    $('.transferList #tableData #sltPageIndex').change(function () {

                        transferList.PageIndex = $(".transferList #tableData #sltPageIndex").children("option:selected").val();
                    ...
                    $('.transferList #tableData #aPrevious').click(function () {

                        if (transferList.PageIndex > 0) {
                            transferList.PageIndex--;
                            transferList.ReloadListData();
                        }

                        return false;
                    });
                    $('.transferList #tableData #aNext').click(function () {

                        if (transferList.PageIndex < (transferList.PageCount - 1)) {
                            transferList.PageIndex++;
                            transferList.ReloadListData();
                        }
        ...
        <asp:View ID="FormContent" runat="server">
            <div class="transferForm" style="padding: 15px;">
                <form class="form-padding">
                    ...
                    <div class="row div-row-padding">
                        <div class="col-md-3 mb-3 text-align-end">
                            <label for="sltDepartmentRequest"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132026") %></label>
                        </div>
                        <div class="col-md-9 mb-9">
                            <select id="sltDepartmentRequest" name="sltDepartmentRequest[]"
                                class="form-control">
                            </select>
                        </div>
                    </div>
                    <div class="row div-row-padding">
                        <div class="col-md-3 mb-3 text-align-end">
                            <label for="sltDepartmentTransfer"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132025") %></label>
                        </div>
                        <div class="col-md-9 mb-9">
                            <select id="sltDepartmentTransfer" name="sltDepartmentTransfer[]"
                                class="form-control">
                            </select>
                        </div>
                    </div>
            ...
            <script type="text/javascript">
                ...
                var transferForm = {
                    GetItem: function (year, id) {
                        $.ajax({
                            type: "POST",
                            url: "TransferData.aspx/GetItem",
                            data: '{year: ' + year + ', id: ' + id + '}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: transferForm.OnSuccessGet,
                            failure: function (response) {
                                alert('<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M111003") %>');
                    ...
                    OnSuccessGet: function (response) {
                        if (response.d == "error") {
                            ...
                            $.each(infors, function (index) {
                                ...
                                $("#sltDepartmentRequest").val($(this).find("F6").text());
                                $("#sltDepartmentTransfer").val($(this).find("F7").text());
                    ...
                    SaveItem: function (data) {
                        $.ajax({
                            type: "POST",
                            url: "TransferData.aspx/SaveItem",
                            data: JSON.stringify({ data: data }),
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: transferForm.OnSuccessSave,
                            failure: function (response) {
                                alert('<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M111004") %>');
                        ...
                        switch (response.d) {
                            case "complete":
                                ...
                                $('#modalNotifyOnlyClose').find('.modal-footer #modalClose').on('click', function () {
                                    ...
                                    // Close modal
                                    transferForm.ClearSession(function () {
                                        modalForm.hideForm();
                    ...
                    ClearSession: function (callbackRedirect) {
                        $.ajax({
                            type: "POST",
                            url: "TransferData.aspx/ClearSessionID",
                            data: '{}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                ...
                $(document).ready(function () {
                    ...
                    $('#modalNotifyConfirmSave').find('.modal-footer #modalConfirmSave').on('click', function () {
                        ...
                        data[6] = $("#sltDepartmentRequest").children("option:selected").val();
                        data[7] = $("#sltDepartmentTransfer").children("option:selected").val();

                        transferForm.SaveItem(data);
                    ...
                    initFunction.setDropdown('#sltDepartmentRequest', 'Department', '<option value="">เลือกแผนก/หน่วยงานที่ขอโอน</option>');
                    initFunction.setDropdown('#sltDepartmentTransfer', 'Department', '<option value="">เลือกแผนก/หน่วยงานที่รับโอน</option>');

                    // Load info command
                    transferForm.GetItem(<%=Request.QueryString["year"]%>, <%=Request.QueryString["id"]%>);
        ...
        <asp:View ID="ViewContent" runat="server">
            <div class="transferView" style="padding: 15px;">
                <form class="form-padding">
                    <div class="row div-row-padding">
                        <div class="col-md-3 mb-3 text-align-end">
                            <label
            ...
            <script type="text/javascript">
                ...
                var transferView = {
                    ViewItem: function (id) {
                        $.ajax({
                            type: "POST",
                            url: "TransferData.aspx/ViewItem",
                            data: '{id: ' + id + '}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: transferView.OnSuccessGet,
                            failure: function (response) {
                                alert('<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M111003") %>');
                ...
                $(document).ready(function () {
                    ...
                    // Load info command
                    transferView.ViewItem(<%=Request.QueryString["id"]%>);
