<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true" CodeBehind="Unit.aspx.cs" Inherits="FingerprintPayment.AssetManagement.Unit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        .unitList #tableData .btn-group a {
            padding: 5px;
        }
    </style>
