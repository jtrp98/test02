<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true" CodeBehind="Transfer.aspx.cs" Inherits="FingerprintPayment.AssetManagement.Transfer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        .transferList #tableData .btn-group a {
            padding: 5px;
        }
    </style>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH3" runat="server">
    ...
    <script type='text/javascript'>
        ...
        $(function () {
            ...
            $.get('TransferData.aspx?v=list', { "id": 0 },
                function (data) {
