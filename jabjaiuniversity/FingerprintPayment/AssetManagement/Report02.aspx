<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report02.aspx.cs" Inherits="Staff.AssetManagement.Report02" %>
    ...
    <div class="reportList">
        <div class="row div-row-padding">
            <div class="col-md-12 mb-12 text-left" style="padding-left: 1%;">
                <span><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132021") %></span>
            </div>
        </div>
        <div class="row div-row-padding">
        ...
        <table id="tableData" class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th style="width: 13%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132003") %></th>
                    <th style="width: 13%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M502020") %></th>
                    <th style="width: 5%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M103205") %></th>
                    <th style="width: 7%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M601045") %></th>
                    <th style="width: 15%" class="text-center">แผนก/หน่วยงาน</th>
                    <th style="width: 10%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132023") %></th>
                    <th style="width: 12%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132022") %></th>
                    <th style="width: 10%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M601070") %></th>
                    <th></th>
                </tr>
            </thead>
    ...
    <script type="text/javascript">
        ...
        var reportList = {
            ...
            LoadListData: function () {
                var dt = $(".reportList #tableData").DataTable({
                    ...
                    "stateSave": true,
                    "ajax": {
                        "url": "Ashx/LoadReport02List.ashx",
                        "type": "POST",
                    ...
                    "columns": [
                        ...
                        { "data": "ResponsibleBy", "orderable": true },
                        { "data": "Receiver", "orderable": true },
                        { "data": "DocumentNo", "orderable": true },
                        { "data": "YearID", "orderable": false }
                    ],
                    "order": [[10, "desc"]],
                    "columnDefs": [
        ...
        $(document).ready(function () {
            ...
            $('.reportList #btnExportFile').click(function () {
                ...
                window.open("Ashx/ExportReport02Excel.ashx?year=" + $("#sltYear").children("option:selected").val() + "&cate=" + $("#sltCategory").children("option:selected").val() + "&col=" + order[0][0] + "&dir=" + order[0][1]);
