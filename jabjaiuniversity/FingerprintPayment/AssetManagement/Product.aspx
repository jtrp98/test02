<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="FingerprintPayment.AssetManagement.Product" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        .productList #tableData .btn-group a {
            padding: 5px;
        }
    </style>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH3" runat="server">
    ...
    <script type='text/javascript'>
        ...
        $(function () {
            ...
            $.get('ProductData.aspx?v=list', { "id": 0 },
                function (data) {
