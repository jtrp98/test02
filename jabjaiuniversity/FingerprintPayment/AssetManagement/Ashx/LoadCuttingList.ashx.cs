...
{
    /// <summary>
    /// Summary description for LoadCuttingList
    /// </summary>
    public class LoadCuttingList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            var json = QueryEngine.LoadCuttingJsonData(draw, pageIndex, pageSize, sortBy, searchDate);
