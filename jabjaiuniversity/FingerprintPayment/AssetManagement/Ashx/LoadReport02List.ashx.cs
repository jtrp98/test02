...
{
    /// <summary>
    /// Summary description for LoadReport02List
    /// </summary>
    public class LoadReport02List : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            var json = QueryEngine.LoadReport02JsonData(draw, pageIndex, pageSize, sortBy, searchYear, searchCategory);
