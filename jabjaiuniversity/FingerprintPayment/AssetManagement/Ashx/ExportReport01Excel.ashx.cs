...
{
    /// <summary>
    /// Summary description for ExportReport01Excel
    /// </summary>
    public class ExportReport01Excel : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            ExcelPackage excel = ReportEngine.ExportReport01Excel(col, dir, year, cate);
