<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WithdrawData.aspx.cs" Inherits="FingerprintPayment.AssetManagement.WithdrawData" %>
...
<body>
    <asp:MultiView ID="MvContent" runat="server">
            ...
            <div class="withdrawList">
                <div class="row">
                    <div class="col-md-4 mb-4 text-left" style="padding-left: 1%;">
                        <span><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132028") %></span>
                    </div>
                ...
                <table id="tableData" class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 15%" class="text-center"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132029") %></th>
                            ...
                            <th style="width: 10%" class="text-center">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalShowForm" form-name="WithdrawData.aspx" form-action="form" form-title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132030") %>"><%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M601032") %></button></th>
                            <th></th>
                            <th></th>
                        </tr>
                    </thead>
            ...
            <script type="text/javascript">
                ...
                var withdrawList = {
                    ...
                    LoadListData: function () {
                        var dt = $(".withdrawList #tableData").DataTable({
                            "processing": true,
                            "serverSide": true,
                            "info": false,
                            "searching": false,
                            ...
                            "stateSave": true,
                            "ajax": {
                                "url": "Ashx/LoadWithdrawList.ashx",
                                "type": "POST",
                                "contentType": "application/json; charset=utf-8",
                                "data": function (d) { 
                                    d.searchDate = '';
                                    d.page = withdrawList.PageIndex;
                                    d.length = withdrawList.PageSize;
                                ...
                                { "targets": [10, 11], "visible": false },
                                {
                                    "render": function (data, type, row) {
                                        return '<div class="btn-group">' +
                                                    //'<a href="#" data-toggle="modal" data-target="#modalShowForm" form-name="WithdrawData.aspx" form-action="view" form-title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132030") %>"><i class="fa fa-user"></i></a>' +
                                                    '<a href="#" data-toggle="modal" data-target="#modalShowForm" form-name="WithdrawData.aspx" form-action="form" form-title="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132030") %>"><i class="fa fa-edit"></i></a>' +
                            ...
                            "drawCallback": function (settings) { 
                                ...
                                withdrawList.PageCount = json.pageCount;

                                var options = '';
                                for (var pi = 0; pi < json.pageCount; pi++) {
                                    options += '<option ' + (withdrawList.PageIndex == pi ? 'selected="selected"' : '') + ' value="' + pi + '">' + (pi + 1) + '</option>';
                                }
                                $('.withdrawList #tableData #sltPageIndex').html(options);

                                $('.withdrawList #tableData #spnPageInfo').html('<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102240") %> ' + (withdrawList.PageIndex + 1) + ' <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M102241") %> ' + withdrawList.PageSize + ' <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M801009") %>');
                            }
                        });
                        // order.dt search.dt
                        dt.on('draw.dt', function () {
                            dt.column(0, { search: 'applied', order: 'applied' }).nodes().each(function (cell, i) {
                                cell.innerHTML = (withdrawList.PageIndex * withdrawList.PageSize) + (i + 1) + '.';
                            });
                    ...
                    RemoveItem: function (year, id) {
                        $.ajax({
                            type: "POST",
                            url: "WithdrawData.aspx/RemoveItem",
                            data: '{year: ' + year + ', id: ' + id + '}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: withdrawList.OnSuccessRemove,
                ...
                $(document).ready(function () {
                    ...
                    $('#modalNotifyConfirmRemove').find('.modal-footer #modalConfirmRemove').on('click', function () {
                        ...
                        // Remove command
                        withdrawList.RemoveItem($(this).attr('year'), $(this).attr('id'));

                    });

                    // Searching, Pagination event 
                    $('.withdrawList #btnSearch').click(function () {

                        withdrawList.PageIndex = 0;
                    ...
                    $('.withdrawList #tableData #sltPageSize').change(function () {

                        withdrawList.PageSize = parseInt($(".withdrawList #tableData #sltPageSize").children("option:selected").val());
                        withdrawList.PageIndex = 0;
                    ...
                    $('.withdrawList #tableData #sltPageIndex').change(function () {

                        withdrawList.PageIndex = $(".withdrawList #tableData #sltPageIndex").children("option:selected").val();
                    ...
                    $('.withdrawList #tableData #aPrevious').click(function () {

                        if (withdrawList.PageIndex > 0) {
                            withdrawList.PageIndex--;
                            withdrawList.ReloadListData();
                        }

                        return false;
                    });
                    $('.withdrawList #tableData #aNext').click(function () {

                        if (withdrawList.PageIndex < (withdrawList.PageCount - 1)) {
                            withdrawList.PageIndex++;
                            withdrawList.ReloadListData();
                        }
        ...
        <asp:View ID="FormContent" runat="server">
            <div class="withdrawForm" style="padding: 15px;">
                <form class="form-padding">
                    ...
                    <div class="row div-row-padding">
                        <div class="col-md-3 mb-3 text-align-end">
                            <label
                                for="sltTransType">
                                <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132029") %></label>
                        </div>
                        <div class="col-md-9 mb-9">
                            <select id="sltTransType" name="sltTransType[]"
            ...
            <script type="text/javascript">
                ...
                var withdrawForm = {
                    GetItem: function (year, id) {
                        $.ajax({
                            type: "POST",
                            url: "WithdrawData.aspx/GetItem",
                            data: '{year: ' + year + ', id: ' + id + '}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: withdrawForm.OnSuccessGet,
                            failure: function (response) {
                                alert('<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M111003") %>');
                    ...
                    OnSuccessGet: function (response) {
                        if (response.d == "error") {
                            ...
                            $.each(infors, function (index) {
                                ...
                                $("#sltTransType").val($(this).find("F3").text());
                    ...
                    SaveItem: function (data) {
                        $.ajax({
                            type: "POST",
                            url: "WithdrawData.aspx/SaveItem",
                            data: JSON.stringify({ data: data }),
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: withdrawForm.OnSuccessSave,
                            failure: function (response) {
                                alert('<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M111004") %>');
                        ...
                        switch (response.d) {
                            case "complete":
                                ...
                                $('#modalNotifyOnlyClose').find('.modal-footer #modalClose').on('click', function () {
                                    ...
                                    // Close modal
                                    withdrawForm.ClearSession(function () {
                                        modalForm.hideForm();
                    ...
                    ClearSession: function (callbackRedirect) {
                        $.ajax({
                            type: "POST",
                            url: "WithdrawData.aspx/ClearSessionID",
                            data: '{}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                ...
                $(document).ready(function () {
                    ...
                    $('#modalNotifyConfirmSave').find('.modal-footer #modalConfirmSave').on('click', function () {
                        ...
                        data[3] = $("#sltTransType").children("option:selected").val();
                    ...
                    // Load info command
                    withdrawForm.GetItem(<%=Request.QueryString["year"]%>, <%=Request.QueryString["id"]%>);
        ...
        <asp:View ID="ViewContent" runat="server">
            <div class="withdrawView" style="padding: 15px;">
                <form class="form-padding">
                    <div class="row div-row-padding">
                        <div class="col-md-3 mb-3 text-align-end">
                            <label
            ...
            <script type="text/javascript">
                ...
                var withdrawView = {
                    ViewItem: function (id) {
                        $.ajax({
                            type: "POST",
                            url: "WithdrawData.aspx/ViewItem",
                            data: '{id: ' + id + '}',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: withdrawView.OnSuccessGet,
                            failure: function (response) {
                                alert('<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M111003") %>');
                ...
                $(document).ready(function () {
                    ...
                    // Load info command
                    withdrawView.ViewItem(<%=Request.QueryString["id"]%>);
