<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true" CodeBehind="SamattanaList.aspx.cs" Inherits="FingerprintPayment.grade.SamattanaList" %>
        ...
        $(document).ready(function () {
            ...
            $('input[id*=btnSearch]').click(function () {
                ...
                if (param4var == undefined)
                    param4var = "";
                window.location.href = "SamattanaList.aspx?idlv=" + param1var + "&idlv2=" + param2var + "&year=" + param3var + "&term=" + param4var + "&mode=" + mode[0].value;
                    ...
                    <asp:GridView ID="dgd" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" ShowFooter="False"
                        ...
                        <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>                                    
                                  <a target="_blank" href="/grade/SamattanaRegister.aspx?year=<%# Eval("year")%>&idlv=<%# Eval("idlv")%>&idlv2=<%# Eval("idlv2")%>&term=<%# Eval("term")%>&id=<%# Eval("planId")%>&mode=<%# Eval("mode")%>" class="btn btn-success greenbutton" 
                                > <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M206001") %></a> 
                                    <a target="_blank" href="/grade/SamattanaPrint.aspx?year=<%# Eval("year")%>&idlv=<%# Eval("idlv")%>&idlv2=<%# Eval("idlv2")%>&term=<%# Eval("term")%>&id=<%# Eval("planId")%>" class="btn btn-warning orangebutton " 
                                > <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132221") %></a> 
                                    <a target="_blank" href="/grade/SamattanaPrint-chalerm.aspx?year=<%# Eval("year")%>&idlv=<%# Eval("idlv")%>&idlv2=<%# Eval("idlv2")%>&term=<%# Eval("term")%>&id=<%# Eval("planId")%>" class="btn btn-warning orangebutton2 hidden" 
                                > <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M206410") %> </a> 
                                    <div class="btn btn-warning greybutton hidden" onclick="bootbox2()"
                                > <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M206410") %></div>                                                                                                      
                                </ItemTemplate>
                                <HeaderStyle Width="25%"></HeaderStyle>
                            </asp:TemplateField>  
