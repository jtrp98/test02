<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true" CodeBehind="scoreRegisterSetting.aspx.cs" Inherits="FingerprintPayment.grade.scoreRegisterSetting" EnableEventValidation="true"%>
  ...
  background: red; /* use your color here */
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            $(function () {
                $("#beforeMid1").datepicker();
                $("#beforeMid2").datepicker();
                $("#duringMid1").datepicker();
                $("#duringMid2").datepicker();
                $("#afterMid1").datepicker();
                $("#afterMid2").datepicker();
                $("#final1").datepicker();
                $("#final2").datepicker();
                $("#extra1").datepicker();
                $("#extra2").datepicker();                
        ...
        $(document).ready(function () {
            ...
            $('input[id*=btnSearch]').click(function () {
                ...
                if (param4var == undefined)
                    param4var = "";
                window.location.href = "scoreRegisterSetting.aspx?year=" + param3var + "&term=" + param4var;
        ...
        <div class="row mini--space__top pagedata hidden">
            <div class="col-xs-12">
                ...
                <label class="centertext">
                    <%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M132252") %></label>
