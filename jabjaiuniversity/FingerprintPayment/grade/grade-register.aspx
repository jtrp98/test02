<%@ Page Title="" Language="C#" MasterPageFile="~/mp.Master" AutoEventWireup="true"
    CodeBehind="grade-register.aspx.cs" Inherits="FingerprintPayment.grade_register" %>
        ...
        <div class="full-card box-content ">
            ...
            <asp:DataGrid ID="dgd" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" AllowCustomPaging="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn ItemStyle-CssClass="centertext" HeaderStyle-CssClass="centertext"  HeaderText="<%= FingerprintPayment.Resources.Resource.ResourceManager.GetString("M204046") %>"> 
                        <HeaderStyle Width="10%"></HeaderStyle>                                           
                        <ItemTemplate>
                            <asp:TextBox  ID="TextBox1" runat="server" Width="50px" Text='<%# Eval("grade") %>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateColumn>
